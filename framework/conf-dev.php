<?php
	...
	$_conf['db']['default']['host'] 	= '10.15.42.42';
	$_conf['db']['default']['catalog']	= 'datamti';
	$_conf['db']['default']['user']		= 'billing';
	$_conf['db']['default']['password']	= 'billingpnkkitasemua';
	
	$_conf['db']['storage']['driver'] 	= 'oci';
	$_conf['db']['storage']['host'] 	= '10.15.42.42';
	$_conf['db']['storage']['catalog']	= 'datamti';
	...
	$_conf['db']['dbint']['host'] 	    = '10.15.42.42';
	$_conf['db']['dbint']['catalog']	= 'datamti';
	$_conf['db']['dbint']['user']		= 'OPUS_REPO';
	$_conf['db']['dbint']['password']	= 'OPUS_REPO';
	
	$_conf['db']['pnoadm']['driver'] 	= 'oci';
	$_conf['db']['pnoadm']['host'] 	    = '10.15.42.42';
	$_conf['db']['pnoadm']['catalog']	= 'datamti';
	...
	$_conf['site']['base'] 			= realpath(str_replace('conf-dev.php','',__FILE__));
	...
	/* API PRAYA */
	define('PRAYA_HOST', "https://praya.ilcs.co.id");
