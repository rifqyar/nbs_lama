<?php
	...
	$_conf['db']['default']['host'] 	= '10.10.32.158';
	...
	$_conf['db']['storage']['host'] 	= '10.10.32.158';
	...
	define('ESB_URL', "http://10.88.56.40:5556/restv2/");
