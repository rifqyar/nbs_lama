...
include ($_SERVER['DOCUMENT_ROOT']."/billing/framework/conf.php");
include ($_SERVER['DOCUMENT_ROOT']."/billing/framework/_debug.php");
include ($_SERVER['DOCUMENT_ROOT']."/billing/framework/_viewstate.php");
include ($_SERVER['DOCUMENT_ROOT']."/billing/framework/init.php");
include ($_SERVER['DOCUMENT_ROOT']."/billing/framework/router.php");
#include "framework/aclcheck.php";
#include ($_SERVER['DOCUMENT_ROOT']."/billing/framework/aclcheck.php");
