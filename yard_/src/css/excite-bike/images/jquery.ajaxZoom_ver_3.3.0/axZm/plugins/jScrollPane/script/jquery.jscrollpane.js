...
(function($,window,undefined){
	...
	$.fn.jScrollPane = function(settings)
	{
		...
		function JScrollPane(elem, s)
		{
			...
			if ($.isFunction($.fn.axZmEmpty)){
				var	originalElement = elem.clone(false, false).axZmEmpty(true);
			}else{
			...
			function initialise(s)
			{
				...
				if (pane === undefined) {
					...
					*/
					...
					if ($.isFunction($.fn.axZmRemove)){
						container.find('>.jspVerticalBar,>.jspHorizontalBar').axZmRemove(true).end();
					}else{
			...
			function destroy(){
				...
				if ($.isFunction($.fn.axZmEmpty)){
					var abc = originalElement.append(pane.children());
					elem.axZmEmpty(true).css('background-image', 'none').replaceWith(abc);
				}else{
