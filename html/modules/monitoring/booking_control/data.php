...
while ($row = $res->fetchRow()) {    
    ...
    $responce->rows[$i]['cell'] = array("<a href=monitoring.booking_control/edit_req?cont_limit=$row[CONTAINER_LIMIT]&voyin=$row[VOYAGE_IN]&voyout=$row[VOYAGE_OUT]&vessel=$row[VESSEL_CODE]><font color=blue><i>Edit</i></font></a>",$row[VESSEL], $row[VOYAGE_IN], $row[VOYAGE_OUT], $row[CONTAINER_LIMIT]);
    $i++;
}
