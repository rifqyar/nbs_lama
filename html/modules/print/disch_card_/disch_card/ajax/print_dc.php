	...
	<tr>
		<td valign="top">
			...
			<tr>
				...
				<td align="center" colspan="4">Temp : <?=$row_dt['TEMP']?></td>
				<td> </td>
				<td colspan="2"> </td>
				<td> </td>
				<td> </td>
