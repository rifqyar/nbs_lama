...
$query="SELECT A.*,B.*,SYSDATE AS TGL_PROSES,to_char(A.INVOICE_DATE,'DD-MM-YYYY') TGL_NOTA2, to_char('0','999,999,999,999,990.00') ADM_NOTAN,to_char(A.PPN,'999,999,999,999,999.00') PPNN,
        to_char(A.JUMLAH,'999,999,999,999,999.00') TAGIHANN,to_char(A.TOTAL,'999,999,999,999,999.00') TOTALN,UPPER(B.TIPE_REQ) TIPE_REQUEST, UPPER(C.NAME) AS NAMA, B.ID_REQUEST AS NOREQ, TO_CHAR(A.TGL_REQUEST,'dd-mm-yyyy') TGL_REQUEST
...
/*PTP*/
    $query = "select fc_nm_perusahaan('$param_tgl','HICO') NM_PERUSAHAAN from dual";
    // echo $query; die();
...
$query_dtl="SELECT A.*,C.*, to_char(A.TARIF,'999,999,999,999,999.00') AS TARIFN, to_char(A.SUB_TOTAL,'999,999,999,999,999.00') AS SUB_TOTALN 
	...
	foreach($row2 as $rows) {
		...
		<tr style="font-weight:bold">    <td colspan="3" width="45"><font size="6">'.$rows[KETERANGAN].'</font></td>                        
                        ...
                        <td width="50" align="right"><font size="6">'.$rows[SUB_TOTALN].'</font></td>        
                        </tr>                        
...
<table>                    
        <tr style="font-weight:bold">
                ...
                <br>
                    <br>
                    <br>
                    <br> <br><font size="8"><b>$nm_perusahaan<b></font><br>
EOD;
$tbl .=<<<EOD
<table> 
                    <tr>
