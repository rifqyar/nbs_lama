...
$db = getDB();
	$query_nota	= "SELECT TO_CHAR (a.CLOSSING_TIME, 'dd/mm/yyyy HH24:MI') CLOSSING_TIME,
					   ...
					   b.VOYAGE_OUT,
					   c.STATUS_CONT,
					   c.SIZE_CONT SIZE_CONT,
					   c.TYPE_CONT AS TYPE_CONT,
					   c.NO_CONTAINER,
					   b.BERAT,
					   a.PELABUHAN_TUJUAN,
					   a.FPOD,
					   ...
					   a.KODE_PBM,
					   b.IMO_CLASS
				  FROM req_receiving_h a, req_receiving_d b, req_rename c
				 WHERE a.ID_REQ = b.ID_REQ AND C.ID_REQ = '$no_req'
	...
	<tr>
		<th height="25" colspan="8" align="left"   scope="row" style="font-size:11px; padding-left:15px; line-height:10px"><?=$row_['VOYAGE_IN'] ?><br /> <?=$row_['NO_CONTAINER']?></th>
		<td width="10%"></td>
		<td width="8%"></td>
		<td></td>
	</tr>
