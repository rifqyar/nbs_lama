...
jQuery(function() {
 jQuery("#print_stacking_card").jqGrid({
	url:'<?=HOME?>datanya/data_cont?q=printRenameContainer',
	mtype : "post",
	datatype: "json",
	colNames:['','No Nota','No Req','EI','QTY','EMKL','Vessel','No Container', 'No Ex Container'], 
	colModel:[
		...
		{name:'ei',index:'ei', width:60, align:"center"},
		...
		{name:'nocont',index:'nocont', width:100, align:"center"},
		{name:'noexcont',index:'noexcont', width:100, align:"center"}
	...
	viewrecords: true,
	shrinkToFit: false,
	caption:"Data Rename Container Card"
 });
...
<div class="content">
	...
	<h2><span class="graybrown">
        ...
        &nbsp;<font color="#0378C6">Cetak</font> Kartu Rename Container 
        </span></h2>	
	<p><br/></p>
