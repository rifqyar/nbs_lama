...
// $cek_alih = "SELECT PERALIHAN FROM REQUEST_RECEIVING WHERE NO_REQUEST = '$no_req'";
// $qcekalih = $db->query($cek_alih);
// $rcekal = $qcekalih->fetchRow();
// if ($rcekal['PERALIHAN'] == 'STRIPPING') {
// 	$cek_lunas = "SELECT LUNAS FROM REQ";
// }
...
//if($gati != 'IN_YARD'){
		/*$qupdate_loc = "UPDATE MASTER_CONTAINER SET LOCATION = 'GATI' WHERE NO_CONTAINER = '$no_cont'";
		$db->query($qupdate_loc);*/
//}
...
$query_insert_out	= "INSERT INTO BORDER_GATE_OUT
						( 	NO_REQUEST, 
							NO_CONTAINER, 
							ID_USER, 
							TGL_IN, 
...
//echo $query_insert;exit;							
	...
	else if($db->query($query_insert))
	{
		...
		//hist 
		$db->query("INSERT INTO HIST_LOCATION(NO_CONTAINER, NO_REQUEST, LOCATION) VALUES('$no_cont','$no_req','GATI')");
