...
$tgl_awal	= $_GET["tgl_awal"]; 
	...
	$query_list_ 	= "SELECT * FROM (
                       ...
                       LEFT JOIN BILLING.REQ_DELIVERY_D RD ON REQUEST_STUFFING.O_REQNBS = trim(RD.ID_REQ) AND CONTAINER_STUFFING.NO_CONTAINER = RD.NO_CONTAINER
                       ...
                       LEFT JOIN BILLING.REQ_DELIVERY_D RD ON REQUEST_STRIPPING.O_REQNBS = trim(RD.ID_REQ) AND CONTAINER_STRIPPING.NO_CONTAINER = RD.NO_CONTAINER 
