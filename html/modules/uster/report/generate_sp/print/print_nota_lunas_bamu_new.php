...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		$this->SetFont('', 'B', 12);
		$this->SetY(36);
		$this->Cell(0, 15, 'NOTA BATAL MUAT', 0, false, 'C', 0, '', 0, false, 'M', 'M');
		$this->SetFont('', '', 12);
		$this->SetY(42);
		$this->SetX(5);
...
EOD;
	...
	, iso_code b WHERE a.id_iso = b.id_iso and a.ID_NOTA = '$no_nota_' AND A.KETERANGAN <> 'ADMIN NOTA'";
