...
header("Content-Disposition: attachment; filename=ReportPenumpukan-".$tanggal.".xls");
                        ...
                        FROM (	
                            ...
                            FROM(				
                                ...
                                WHERE
                                    ...
                                    C.NOTA = 'Y'
                                    --AND C.TGL_REQUEST BETWEEN TO_DATE('26/02/2019','DD/MM/YYYY') AND TO_DATE('01/03/2019','DD/MM/YYYY')
                                    AND C.TGL_REQUEST BETWEEN TO_DATE('$tgl_awal','DD/MM/YYYY') AND TO_DATE('$tgl_akhir','DD/MM/YYYY') -- ganti tanggal ini untuk memilih tanggal yang diinginkan
                        ...
                        FROM (	
                            ...
                            FROM(			
                                ...
                                WHERE
                                    C.NOTA = 'Y'
                                    AND A.ASAL_CONT = 'TPK'
                                    --AND C.TGL_REQUEST BETWEEN TO_DATE('26/02/2019','DD/MM/YYYY') AND TO_DATE('01/05/2019','DD/MM/YYYY')
                                    AND C.TGL_REQUEST BETWEEN TO_DATE('$tgl_awal','DD/MM/YYYY') AND TO_DATE('$tgl_akhir','DD/MM/YYYY') -- ganti tanggal ini untuk memilih tanggal yang diinginkan
                                ORDER BY A.no_request ASC			
                                )V								
                        )X	ORDER BY no_request	 	
 ...
 <div id="list">
     <table class="grid-table" border='1' cellpadding="1" cellspacing="1"  width="100%" >
                <?php 
                    if($jenis == 'REPO') { ?>
                        <tr>
                            <th colspan="18">REPORT PENUMPUKAN <?php echo $jenis; ?></th>
                        </tr>
                        <tr>
                            <th colspan="18">PT. PELABUHAN INDONESIA II - CABANG PONTIANAK</th>
                        </tr>
                        <tr>
                            <th colspan="18"><?=$tgl_awal?> - <?=$tgl_akhir?> </th>
                        </tr>

                              <tr style=" font-size:10pt">
                                  <th valign="top" class="grid-header" style="font-size:8pt">No</th>
                                  <th valign="top" class="grid-header"  style="font-size:8pt">Nota TPK </th>
                                  <th valign="top" class="grid-header"  style="font-size:8pt">Nota Uster </th>
                                  <th valign="top" class="grid-header" style="font-size:8pt">Nilai Nota </th>
								  ...
								  <th valign="top" class="grid-header"  style="font-size:8pt">Total Penumpukan</th>
								  <th valign="top" class="grid-header"  style="font-size:8pt">Total Penumpukan + PPN</th>
                                  ...
                                  <th valign="top" class="grid-header" style="font-size:8pt">Penumpukan TPK</th>
                                  <th valign="top" class="grid-header" style="font-size:8pt">PPN Penumpukan TPK</th>
                                  ...
                                  <th valign="top" class="grid-header" style="font-size:8pt">Total Hak TPK + PPN</th>
                              </tr>
                              <?php $i=0;
                              ...
                              <tr>
                                  ...
                                  <td width="22%" align="center" valign="middle" class="grid-cell"  style="font-size:9pt"><b><?php echo $rows["NOTA_TPK"]; ?></b></td>
                                  <td width="15%" align="center" valign="middle" class="grid-cell"  style="font-size:9pt"><?php echo $rows["NOTA_USTER"]; ?></td>
                                  <td width="15%" align="center" valign="middle" class="grid-cell"  style="font-size:9pt"><?php echo $rows["NILAI_NOTA"]; ?></td>
                                  <td width="15%" align="center" valign="middle" class="grid-cell"  style="font-size:9pt"><?php echo $rows["TGL_REQUEST"]; ?></td>
                                  <td width="15%" align="center" valign="middle" class="grid-cell"  style="font-size:9pt"><?php echo $rows["NO_REQUEST"]; ?></td>
                                  <td width="15%" align="center" valign="middle" class="grid-cell"  style="font-size:9pt"><?php echo $rows["BIAYA_MASA11"]; ?></td>
                                  <td width="15%" align="center" valign="middle" class="grid-cell"  style="font-size:9pt"><?php echo $rows["BIAYA_MASA12"]; ?></td>
                                  <td width="15%" align="center" valign="middle" class="grid-cell"  style="font-size:9pt"><?php echo $rows["BIAYA_MASA2"]; ?></td>
                                  <td width="15%" align="center" valign="middle" class="grid-cell"  style="font-size:9pt"><?php echo $rows["TOTAL_PENUMPUKAN"]; ?></td>
                                  <td width="15%" align="center" valign="middle" class="grid-cell"  style="font-size:9pt"><?php echo $rows["TOTAL_PENUMPUKAN_PLUS_PPN"]; ?></td>
                                  <td width="15%" align="center" valign="middle" class="grid-cell"  style="font-size:9pt"><?php echo $rows["BIAYA_MASA12_TPK"]; ?></td>
                                  <td width="15%" align="center" valign="middle" class="grid-cell"  style="font-size:9pt"><?php echo $rows["BIAYA_MASA2_TPK"]; ?></td>
                                  <td width="15%" align="center" valign="middle" class="grid-cell"  style="font-size:9pt"><?php echo $rows["PENUMPUKAN_TPK"]; ?></td>
                                  <td width="15%" align="center" valign="middle" class="grid-cell"  style="font-size:9pt"><?php echo $rows["PPN_PENUMPUKAN_TPK_10_PERSEN"]; ?></td>
                                  <td width="15%" align="center" valign="middle" class="grid-cell"  style="font-size:9pt"><?php echo $rows["LIFT_OFF_TPK"]; ?></td>
                                  <td width="15%" align="center" valign="middle" class="grid-cell"  style="font-size:9pt"><?php echo $rows["LIFT_OFF_TPK_PPN"]; ?></td>
                                  <td width="15%" align="center" valign="middle" class="grid-cell"  style="font-size:9pt"><?php echo $rows["TOTAL_HAK_TPK_DAN_PPN"]; ?></td>
							</tr>
                            <?php }
                        }
                        else { ?>
                            <tr>
                                <th colspan="15">REPORT PENUMPUKAN <?php echo $jenis; ?></th>
                            </tr>
                            <tr>
                                <th colspan="15">PT. PELABUHAN INDONESIA II - CABANG PONTIANAK</th>
                            </tr>
                            <tr>
                                <th colspan="15"><?=$tgl_awal?> - <?=$tgl_akhir?> </th>
                            </tr>
                            <tr style=" font-size:10pt">
                                  <th valign="top" class="grid-header" style="font-size:8pt">No</th>
                                  <th  valign="top" class="grid-header"  style="font-size:8pt">No. Request</th> 
                                  ...
                                  <th valign="top" class="grid-header" style="font-size:8pt">Penumpukan USTER</th>
                                  <th valign="top" class="grid-header" style="font-size:8pt">PPN Penumpukan USTER 10 Persen</th>
                                  <th valign="top" class="grid-header" style="font-size:8pt">Total Penumpukan USTER + PPN</th>
                                  <th valign="top" class="grid-header" style="font-size:8pt">Hak TPK</th>
                                  <th valign="top" class="grid-header" style="font-size:8pt">Lift On TPK + PPN</th>
                                  <th valign="top" class="grid-header" style="font-size:8pt">Total Hak TPK</th>
                              </tr>
                              <?php $i=0;
							  foreach($row_list as $rows){ $i++;?>
                              <tr>
                                  <td width="4%" align="center" valign="middle" class="grid-cell" style="color:#000;  font-size:9pt"><?php echo $i; ?></td>
                                  <td width="22%" align="center" valign="middle" class="grid-cell"  style="font-size:9pt"><b><?php echo $rows["NO_REQUEST"]; ?></b></td>
                                  <td width="15%" align="center" valign="middle" class="grid-cell"  style="font-size:9pt"><?php echo $rows["BIAYA_MASA11"]; ?></td>
                                  <td width="15%" align="center" valign="middle" class="grid-cell"  style="font-size:9pt"><?php echo $rows["BIAYA_MASA12"]; ?></td>
                                  <td width="15%" align="center" valign="middle" class="grid-cell"  style="font-size:9pt"><?php echo $rows["BIAYA_MASA2"]; ?></td>
                                  <td width="15%" align="center" valign="middle" class="grid-cell"  style="font-size:9pt"><?php echo $rows["TOTAL_PENUMPUKAN"]; ?></td>
                                  <td width="15%" align="center" valign="middle" class="grid-cell"  style="font-size:9pt"><?php echo $rows["TOTAL_PENUMPUKAN_PLUS_PPN"]; ?></td>
                                  <td width="15%" align="center" valign="middle" class="grid-cell"  style="font-size:9pt"><?php echo $rows["BIAYA_MASA12_USTER"]; ?></td>
                                  <td width="15%" align="center" valign="middle" class="grid-cell"  style="font-size:9pt"><?php echo $rows["BIAYA_MASA2_USTER"]; ?></td>
                                  <td width="15%" align="center" valign="middle" class="grid-cell"  style="font-size:9pt"><?php echo $rows["PENUMPUKAN_USTER"]; ?></td>
                                  <td width="15%" align="center" valign="middle" class="grid-cell"  style="font-size:9pt"><?php echo $rows["PPN_PENUMPUKAN_USTER_10_PERSEN"]; ?></td>
                                  <td width="15%" align="center" valign="middle" class="grid-cell"  style="font-size:9pt"><?php echo $rows["TOTAL_PENUMPUKAN_USTER_DAN_PPN"]; ?></td>
                                  <td width="15%" align="center" valign="middle" class="grid-cell"  style="font-size:9pt"><?php echo $rows["HAK_TPK"]; ?></td>
                                  <td width="15%" align="center" valign="middle" class="grid-cell"  style="font-size:9pt"><?php echo $rows["LIFT_ON_TPK_PPN"]; ?></td>
                                  <td width="15%" align="center" valign="middle" class="grid-cell"  style="font-size:9pt"><?php echo $rows["TOTAL_HAK_TPK"]; ?></td>
                        <?php }
                    } ?>
        </table>
 </div>