<?php
	...
	if($r_cutoff['STATUS'] == 'OK'){
		// REMARKED BY YOSUA CHRISTIANOV ITSD (23/07/2020) USTER DOUBLE DATA
		 ...
		 //                                                         'dd-mm-rrrr')
		 //       AND  line_description LIKE 'PNP%') where 1=1 ".$f_jenis. " ". $orderby;
		// END REMARK BY YOSUA CHRISTIANOV ITSD (23/07/2020) USTER DOUBLE DATA

		// EDITED BY YOSUA CHRISTIANOV ITSD (23/07/2020) USTER DOUBLE DATA
...
) where 1=1 ".$f_jenis. " ". $orderby;
		// END EDIT BY YOSUA CHRISTIANOV ITSD (23/07/2020) USTER DOUBLE DATA
	}
	else{
