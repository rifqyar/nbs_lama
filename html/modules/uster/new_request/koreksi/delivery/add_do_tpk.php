...
//-------------------------------------------------- END INSERT TPK's RECEIVING -------------------------------------------------------//	
	...
	//echo $query_cek."<br/>";
	//echo $no_req.$jum."<br/>";
            $query_req 	= "INSERT INTO request_delivery(NO_REQUEST, ID_EMKL, REQ_AWAL, TGL_REQUEST, TGL_REQUEST_DELIVERY, KETERANGAN, CETAK_KARTU, ID_USER, DELIVERY_KE, ID_VOYAGE, PERALIHAN, ID_YARD, STATUS,PEB, NPE) 
                                                      VALUES ('$no_req', $ID_EMKL, '$no_req',SYSDATE, TO_DATE('".$TGL_REQ."','yyyy/mm/dd'),'$KETERANGAN', '0', $ID_USER, '$DEV_KE',$NO_BOOKING,'T','$ID_YARD','NEW','$PEB','$NPE')";
