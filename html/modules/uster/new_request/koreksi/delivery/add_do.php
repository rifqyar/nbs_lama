...
//-------------------------------------------------- END INSERT TPK's RECEIVING -------------------------------------------------------//	
	...
	//echo $no_req.$jum."<br/>";
				...
				$query_req 	= "INSERT INTO request_delivery(NO_REQUEST, REQ_AWAL, TGL_REQUEST, TGL_REQUEST_DELIVERY, KETERANGAN, DELIVERY_KE, CETAK_KARTU, ID_USER,  PERALIHAN, ID_YARD, STATUS,KD_EMKL) 
                                                      VALUES ('$no_req', '$no_req',SYSDATE, TO_DATE('".$TGL_REQ."','yyyy/mm/dd'),'$KETERANGAN', 'LUAR','0', $ID_USER,'T','$ID_YARD','NEW','$EMKL')";
              $db->query($history);
//echo "$query_req";die;
