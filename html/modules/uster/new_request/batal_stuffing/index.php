...
jQuery(function() {
 jQuery("#l_delivery").jqGrid({
	url:'<?=HOME?>datanya/batal_spps',
	mtype : "post",
	datatype: "json",
	colNames:['','No BA','No Req SPPS','No Container','Tgl Batal SPPS','Vessel', 'Voyage In'],
	colModel:[
...
<div class="content">
	<div class="main_side">
	<p>
	<h2> <img src="<?=HOME?>images/delivery.png" height="5%" width="5%" style="vertical-align:middle"> Request Batal Stuffing</h2></p>
	<p><br/>
	  <a href="<?=HOME?>uster.new_request.batal_stuffing/batal_stuffing" class="link-button">
