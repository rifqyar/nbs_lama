...
$param = array(
                    ...
                    "in_datedisch" => $tgl_bongkar ? date('d-m-Y', strtotime($tgl_bongkar)) : '',
                    "in_tglmulai" => $tgl_mulai? date('d-m-Y', strtotime($tgl_mulai)) : '',
                    "in_tglselesai" => $tgl_selesai ? date('d-m-Y', strtotime($tgl_selesai)) : '',
                    "in_blok" => $blok_,
                    "in_slot" => $slot_,
                    "in_row"=> $row_,
                    "in_tier" => $tier_,
