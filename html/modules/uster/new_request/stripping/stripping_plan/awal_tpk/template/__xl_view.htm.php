<?php if (!defined("XLITE_INCLUSION")) die(); ?><span class="graybrown"><img src='images/document-open.png' border='0' class="icon"/><font color="#DE7E21"> Perencanaan Stripping Petikemas </font></span><fieldset class="form-fieldset" style="margin: 5px 5px 5px 5px; "><form id="form-add" action="<?=HOME?><?=APPID?>/add_edit" method="POST"> <center><table style="margin: 30px 30px 30px 30px;" ><tr><td class="form-field-caption">Nomor Request</td><td class="form-field-caption"> : </td><td class="form-field-input"><input type="text" name="NO_REQ" id="NO_REQ" value="<?php echo($row_request["NO_REQUEST_PLAN"]); ?>" readonly="readonly" /> &nbsp; <input type="text" id="NO_REQ2" name="NO_REQ2" value="<?php echo($row_request["O_REQNBS"]); ?>" readonly="readonly" /></td></tr><tr><td class="form-field-caption">Penerima / Consignee</td><td class="form-field-caption"> : </td><td><input type="text" id="CONSIGNEE" size="40" name="CONSIGNEE" class="kdemkl " placeholder="<?php echo($row_request["NAMA_PEMILIK"]); ?>" value="<?php echo($row_request["NAMA_PEMILIK"]); ?>" style="background-color:#FFFFCC;" /><input size="40" name="ID_CONSIGNEE" id="ID_CONSIGNEE" type="hidden" value="<?php echo($row_request["KD_CONSIGNEE"]); ?>" /><input size="40" name="ALMT_CONSIGNEE" id="ALMT_CONSIGNEE" type="hidden" /><input size="40" name="NPWP_CONSIGNEE" id="NPWP_CONSIGNEE" type="hidden" /></td></tr><tr><td class="form-field-caption">Nama Personal Consignee</td><td class="form-field-caption"> : </td><td><input type="text" id="CONSIGNEE_PERSONAL" size="40" name="CONSIGNEE_PERSONAL" placeholder="<?php echo($row_request["CONSIGNEE_PERSONAL"]); ?>" value="<?php echo($row_request["CONSIGNEE_PERSONAL"]); ?>" style="background-color:#FFFFCC;" /></td></tr><tr><td class="form-field-caption"></td><td></td><td><input type="hidden" id="PENUMPUKAN" size="40" name="PENUMPUKAN" class="kdemkl " placeholder="<?php echo($row_request["NAMA_PENUMPUK"]); ?>" style="background-color:#FFFFCC;" /><input size="40" name="ID_PENUMPUKAN" id="ID_PENUMPUKAN" type="hidden" /><input size="40" name="ALMT_PENUMPUKAN" id="ALMT_PENUMPUKAN" type="hidden" /><input size="40" name="NPWP_PENUMPUKAN" id="NPWP_PENUMPUKAN" type="hidden" /></td></tr><tr><td class="form-field-caption">Nama Kapal</td><td> : </td><td><input id="NM_KAPAL" size="40" name="NM_KAPAL" type="text" style="background-color:#FFFFCC;" value="<?php echo($row_request["O_VESSEL"]); ?>" />&nbsp;&nbsp; <input type="text" id="VOYAGE_IN" size="5" name="VOYAGE_IN" value="<?php echo($row_request["O_VOYIN"]); ?>" /> - <input type="text" id="VOYAGE_OUT" size="5" name="VOYAGE_OUT" value="<?php echo($row_request["O_VOYOUT"]); ?>" /><input type="text" id="VOYAGE_OUT" size="5" name="VOYAGE_OUT" value="<?php echo($row_request["O_IDVSB"]); ?>" /></td></tr><!-- <tr>
		...
		</tr> --><tr><td class="form-field-caption">Nomor D.O</td><td class="form-field-caption"> : </td><td class="form-field-input"><input type="text" id="NO_DO" name="NO_DO" value="<?php echo($row_request["NO_DO"]); ?>" /></td></tr><tr><td class="form-field-caption">Nomor B.L</td><td class="form-field-caption"> : </td><td class="form-field-input"><input type="text" id="NO_BL" name="NO_BL" value="<?php echo($row_request["NO_BL"]); ?>" /></td></tr><tr><td class="form-field-caption">Nomor SPPB</td><td class="form-field-caption"> : </td><td><input type="text" id="NO_SPPB" size="40" name="NO_SPPB" value="<?php echo($row_request["NO_SPPB"]); ?>" /></td></tr><tr><td class="form-field-caption">Tanggal SPPB</td><td class="form-field-caption"> : </td><td><input type="text" id="TGL_SPPB" name="TGL_SPPB" value="<?php echo($row_request["TGL_SPPB"]); ?>" /></td></tr><tr><td class="form-field-caption">Type Stripping</td><td class="form-field-caption"> : </td><!--<td class="form-field-input"> <input type="text" name="TYPE_S" id="TYPE_S" value="<?php echo($row_request["TYPE_STRIPPING"]); ?>" readonly="readonly"/> </td>--><td> <?php echo($dla); ?> </td></tr><tr><td class="form-field-caption">Keterangan</td><td class="form-field-caption"> : </td><td class="form-field-input"><input type="text" id="keterangan" name="keterangan" style="width:250px" value="<?php echo($row_request["KETERANGAN"]); ?>" /></td></tr><?php
        	if($row_request["APPROVE"] == "NY")
            {
        ?><tr><td colspan="5" class="form-footer"><a id="submitForm" onclick="save()" class="link-button" ><img src='images/valid.png' border='0' />&nbsp;Simpan Hasil Edit</a></td></tr><!--<tr>
        ...
        ?></table></center></form></fieldset><fieldset id="cont-fieldset" class="form-fieldset" style="margin: 5px 5px 5px 5px; "><center><table style="margin: 30px 30px 30px 30px;border:thin groove;"  ><tr><td class="form-field-caption"> Nomor Container </td><td class="form-field-caption"> : </td><td><input type="text" name="NO_CONT" ID="NO_CONT" /></td><td style="width:200px;">&nbsp; <input type="hidden" name="NO_DEL_REQ" id="NO_DEL_REQ" value="<?php echo($row_request2["NO_DEL_REQ"]); ?>" /><input type="hidden" name="BP_ID" ID="BP_ID" readonly="readonly" /><input type="hidden" name="NO_UKK" ID="NO_UKK" readonly="readonly" /><input type="hidden" name="TGL_STACK" ID="TGL_STACK" readonly="readonly" /><input type="hidden" name="SP2" ID="SP2" value="<?php echo($sp2); ?>" readonly="readonly" /><input type="hidden" name="BLOK" ID="BLOK" readonly="readonly" /><input type="hidden" name="SLOT" ID="SLOT" readonly="readonly" /><input type="hidden" name="ROW" ID="ROW" readonly="readonly" /><input type="hidden" name="TIER" ID="TIER" readonly="readonly" /></td><td class="form-field-caption"> Ukuran </td><td class="form-field-caption"> : </td><td><input type="text" name="SIZE" ID="SIZE" readonly="readonly" style="background-color:#FFFFCC;" /></td></tr><tr><td class="form-field-caption">Lokasi</td><td class="form-field-caption">:</td><td><input type="text" name="ASAL_CONT" ID="ASAL_CONT" readonly="readonly" /></td><td style="width:200px;">&nbsp; <td></td><td></td><td></td></tr><tr><td class="form-field-caption"> Status </td><td class="form-field-caption"> : </td><td><input type="text" name="STATUS" ID="STATUS" readonly="readonly" style="background-color:#FFFFCC;" /></td><td style="width:200px;">&nbsp;</td><td class="form-field-caption"> Type </td><td class="form-field-caption"> : </td><td><input type="text" name="TIPE" ID="TYPE" readonly="readonly" style="background-color:#FFFFCC;" /></td></tr><tr><td class="form-field-caption"> Berbahaya </td><td class="form-field-caption"> : </td><td><select name="BERBAHAYA" id="BERBAHAYA"><?php $this->renderSelectOptions(array (
  0 => 
  array (
    'value' => 'N',
    'label' => 'TIDAK',
...
),$false,$false,'0','1'); ?></select></td><td style="width:200px;">&nbsp;</td><td class="form-field-caption"> Komoditi </td><td class="form-field-caption"> : </td><td><input type="text" name="KOMODITI" ID="KOMODITI" /></td><td></td><td></td><td></td></tr><tr><td class="form-field-caption">Voyage / Kapal</td><td class="form-field-caption"> : </td><td><input type="text" name="VOYAGE" id="VOYAGE" placeholder="<?php echo($row_request["VOYAGE"]); ?>" style="background-color:#FFFFCC;" /> / <input name="VESSEL" id="VESSEL" placeholder="<?php echo($row_request["VESSEL"]); ?>" style="background-color:#FFFFCC;" /><input type="hidden" name="NO_BOOKING" id="NO_BOOKING" value="<?php echo($row_request["NO_BOOKING"]); ?>" /></td><td style="width:200px;">&nbsp;</td><td class="form-field-caption"> TANGGAL BONGKAR</td><td class="form-field-caption"> : </td><td><input type="text" name="TGL_BONGKAR" ID="TGL_BONGKAR" readonly="1" /></td></tr><tr><td class="form-field-caption"> Depo Tujuan </td><td class="form-field-caption"> : </td><td><input type="text" id="lokasi" name="lokasi" readonly="readonly" /></td><td style="width:200px;">&nbsp;</td><td class="form-field-caption"> Tujuan Setelah Stripping <font style="color:red">*</font></td><td class="form-field-caption"> : </td><td><select disabled="1" name="AFTER_STRIP" id="AFTER_STRIP"><?php $this->renderSelectOptions(array (
  0 => 
  array (
    'value' => 'Depo Empty',
    'label' => 'Depo Empty',
...
),$false,$false,'0','1'); ?></select></td></tr><tr><td class="form-field-caption"> Tgl Mulai Stripping </td><td class="form-field-caption"> : </td><td><input readonly="1" disabled="1" type="text" name="tgl_mulai" ID="tgl_mulai" /></td><td style="width:200px;">&nbsp;</td><td class="form-field-caption"> Tgl Selesai Stripping </td><td class="form-field-caption"> : </td><td><input type="text" name="tgl_selesai" ID="tgl_selesai" /></td><!--<td> <input type="text" name="tgl_selesai" ID="TGL_SELESAI" readonly disabled/> </td>--><td></td><td></td><td></td></tr><br /><?php
        	if($row_request["APPROVE"] != "Y")
            {
        ?><tr align="center"><td colspan="7"><a id="submit" class="link-button" id="add_cont" onclick="add_cont()"><img src='images/valid.png' border='0' />&nbsp;Tambahkan Container</a></td></tr><tr height="15"><td></td></tr><?php
        	}
        ?></table><div id="cont_list" style="margin: 10px 10px 10px 10px; border:thin inset"></div></center></fieldset><div id="dialog-form"></div><div id="demo8"></div><?php $jml_tmp = count($row_list);?><input type="hidden" value="<?php echo($jml_tmp); ?>" id="jml_tmp" /><script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script><script>
function save_request($total){
var answer = confirm("Yakin untuk menyimpan request ini?");
if(answer){
  var no_req = '<?php echo($row_request["NO_REQUEST_PLAN"]); ?>';
  var url	= "<?php echo($HOME); ?><?php echo($APPID); ?>.ajax/save_req";
  $('#button_save').html('<p align=center><img src=<?php echo($HOME); ?>images/animated_loading.gif /></p>');
  for($i=1; $i<=$total; $i++){
...
function unsave_request(){
	var no_req = '<?php echo($row_request["NO_REQUEST_PLAN"]); ?>';
	var url	= "<?php echo($HOME); ?><?php echo($APPID); ?>.ajax/unsave_req";
	$('#button_save').html('<p align=center><img src=<?php echo($HOME); ?>images/animated_loading.gif /></p>');
	$.post(url,{NO_REQ : no_req}, function(data){
		...
		window.open('<?php echo($HOME); ?><?php echo($APPID); ?>/view?no_req='+no_req,'_self');
	});
}
$(function(){
	$( "#dialog-form" ).dialog({
...
$(function() {	
	...
	$( "#NO_CONT" ).autocomplete({
		minLength: 6,
		//source: "<?php echo($HOME); ?><?php echo($APPID); ?>.auto/containerunion?VOYAGE="+<?php echo($row_request["O_VOYIN"]); ?>+"&ID_VSB="+<?php echo($row_request["O_IDVSB"]); ?>,
        source: function(request, response) {
        $.getJSON("<?php echo($HOME); ?><?php echo($APPID); ?>.auto/containerunion_praya", { NO_CONTAINER:$( "#NO_CONT" ).val(), VOYAGE: "<?php echo($row_request["O_VOYAGE"]); ?>", ID_VSB:"<?php echo($row_request["O_IDVSB"]); ?>", VOYIN:"<?php echo($row_request["O_VOYIN"]); ?>", VOYOUT:"<?php echo($row_request["O_VOYOUT"]); ?>", VESCODE:"<?php echo($row_request["O_VESCODE"]); ?>" },
              response);
        },
		focus: function( event, ui ) {
		...
		select: function( event, ui ) {
			...
			$("#NO_UKK").val( "<?php echo($row_request["O_IDVSB"]); ?>");
			$("#NM_AGEN").val( ui.item.NM_AGEN);
			$("#BP_ID").val( "BP<?php echo($row_request["O_VESCODE"]); ?><?php echo($row_request["O_IDVSB"]); ?>");
			$("#ASAL_CONT").val( 'TPK');
			$("#NO_BOOKING").val( "BP<?php echo($row_request["O_VESCODE"]); ?><?php echo($row_request["O_IDVSB"]); ?>");
	...
	$( "#VOYAGE" ).autocomplete({
		minLength: 3,
		source: "<?php echo($HOME); ?><?php echo($APPID); ?>.auto/voyage",
		focus: function( event, ui ) {
	...
	$("#cont_list").load('<?=HOME?><?=APPID?>/cont_list?no_req=<?php echo($row_request["NO_REQUEST_PLAN"]); ?> #list', function(data) {        	  		
...
function add_cont()
{
	...
	var no_req_		= "<?php echo($row_request["NO_REQUEST_PLAN"]); ?>";
	...
	var row_		= $("#ROW").val();
	var tier_		= $("#TIER").val();
	var url				= "<?php echo($HOME); ?><?php echo($APPID); ?>.ajax/add_cont_praya";
	var ind = $("#jml_tmp").val();   
	ind++;
...
{	
	...
	$("#TGL_SPPB").val('<?php echo($row_request["TGL_SPPB"]); ?>');
...
if($tgl_approve == '' || $tgl_app_sel == ''){
	...
	$.getJSON("<?php echo($HOME); ?><?php echo($APPID); ?>.auto/containerunion_praya", { NO_CONTAINER:$no_cont, VOYAGE: "<?php echo($row_request["O_VOYIN"]); ?>", ID_VSB:"<?php echo($row_request["O_IDVSB"]); ?>", VOYIN:"<?php echo($row_request["O_VOYIN"]); ?>", VOYOUT:"<?php echo($row_request["O_VOYOUT"]); ?>", VESCODE:"<?php echo($row_request["O_VESCODE"]); ?>" }).done(function( json ) {
