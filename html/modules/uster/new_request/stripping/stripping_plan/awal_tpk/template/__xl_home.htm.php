	...
	<fieldset class="form-fieldset" style="margin: 5px 5px 5px 5px; ">
		<center>
			<table style="margin: 30px 30px 30px 30px;" border="0">
				<tr>
					<td>No. Rencana Stripping</td>
					<td> : </td>
					<td><input type="text" name="No_Req" id="no_req" /></td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="3" align="right"><a class="link-button" style="height:25" onclick="search_request()"><img src='images/cari.png' border='0' />Cari</a></td>
				</tr>
			</table>
		</center>
	</fieldset>
	<fieldset class="form-fieldset" style="margin: 5px 5px 5px 5px; "> &nbsp;&nbsp;<a href='<?php echo ($HOME); ?><?php echo ($APPID); ?>/add' class="link-button"><img src='images/tambah.png' border="0"> Tambah Request Stripping</a>&nbsp;<br /><br /></fieldset>
	<fieldset class="form-fieldset" style="margin: 5px 5px 5px 5px; ">
		<center>
