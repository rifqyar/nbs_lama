...
//END CARI NO_REQ_DEL
	...
	$sql 	= "INSERT INTO PETIKEMAS_CABANG.TTM_DEL_REQ
								  (NO_REQ_DEL, 
								   TGL_REQ,
								   TGL_BAYAR2, // BELOM FIX
								   KD_PBM,   
								   NM_AGEN,    // BELOM DAPET DARI USTER
								   DEL_VIA_STATUS,
								   TUJUAN,     
								   KETERANGAN, 
								   NO_DO,
								   ...
								   NO_SPPB, 
								   TGL_SPPB,
								   ENTRY_BY,   //perlu nama user
								   ENTRY_DATE
								   ) 
		   						   VALUES
								   ('$autobp', 
		   							SYSDATE,
		   						    to_date('".$_POST["BAYAR_2"]."','DD-MM-YYYY HH24:MI:SS'),  
								    $id_emkl,
									'".$_POST['NM_AGEN']."',  
								    '1',   
								    'USTER', 
