...
<div class="content">
	<div class="main_side">
	<p>
	<h2> <img src="<?=HOME?>images/delivery.png" height="5%" width="5%" style="vertical-align:middle"> Request Batal SPPS</h2></p>
	<p><br/>
	  <a href="<?=HOME?>uster.new_request.batal_spps/batal_spps" class="link-button">
