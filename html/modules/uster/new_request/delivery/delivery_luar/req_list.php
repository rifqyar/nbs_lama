<?php
	...
	{
		$db 		= getDB("storage");
		$query_cek	= "SELECT A.NOTA, A.KOREKSI, B.LUNAS FROM REQUEST_DELIVERY A LEFT JOIN NOTA_DELIVERY B ON A.NO_REQUEST = B.NO_REQUEST WHERE A.NO_REQUEST = '$no_req' ORDER BY A.TGL_REQUEST DESC";	
