...
$query_list ="  SELECT DISTINCT MASTER_CONTAINER.*, CONTAINER_DELIVERY.*, YARD_AREA.NAMA_YARD
                    FROM MASTER_CONTAINER RIGHT JOIN CONTAINER_DELIVERY ON MASTER_CONTAINER.NO_CONTAINER = CONTAINER_DELIVERY.NO_CONTAINER
                         INNER JOIN YARD_AREA ON CONTAINER_DELIVERY.ID_YARD= YARD_AREA.ID LEFT JOIN
                         PETIKEMAS_CABANG.TTD_CONT_EXBSPL TD ON TD.NO_CONTAINER = CONTAINER_DELIVERY.NO_CONTAINER
						  WHERE CONTAINER_DELIVERY.NO_REQUEST = '$no_req'
