...
if ($hz == 'N')   
   {$hzict = 'T';}else{$hzict = 'Y';}
	...
	$query_cek		= "SELECT a.ID_YARD_AREA FROM placement b, blocking_area a 
        ...
        $query_insert   = "INSERT INTO CONTAINER_DELIVERY(NO_CONTAINER, NO_REQUEST, STATUS, AKTIF, KELUAR,HZ, KOMODITI,KETERANGAN,NO_SEAL,BERAT,VIA, ID_YARD, NOREQ_PERALIHAN, START_STACK, TGL_DELIVERY, ASAL_CONT) 
        VALUES('$no_cont', '$no_req', '$status','Y','N','$hz','$komoditi','$keterangan','$no_seal','$berat','$via','$id_yard_','$no_request', TO_DATE('$start_stack','MM/DD/YYYY'), TO_DATE('$tgl_delivery','MM/DD/YYYY'), '$asal_cont')";
