...
// --TAMBAH REQUEST BARU CONTAINER YG DI STUFFING
// --Model Dokumentasi
// -- Daftar Isi
// 1 - 
	// 1.1 -
			...
			if($db->query($sqlict_del)){ 		//eksekusi auto request delivery ICT
				if($db->query($query_req_rec)){ // eksekusi auto request receiving USTER
					...
					{	
						...
						$query_ir = "INSERT INTO REQUEST_STUFFING(	NO_REQUEST, ID_YARD, CETAK_KARTU_SPPS, 
																	KETERANGAN, NO_BOOKING,
																	TGL_REQUEST, NO_DOKUMEN, NO_JPB, BPRP, ID_PEMILIK, ID_EMKL, 
																	NO_REQUEST_RECEIVING, ID_USER,
																	NO_REQUEST_DELIVERY, KD_CONSIGNEE, KD_PENUMPUKAN_OLEH, 
																	NM_KAPAL, NO_PEB, NO_NPE, 
																	VOYAGE, STUFFING_DARI, 
																	NOTA,
																	EARLY_STUFFING) 
															VALUES(	'$no_req_p',
																	'$id_yard',
