...
//------------------------	
	...
	// "select 	a.NM_AGEN, a.KD_AGEN, a.KD_KAPAL, a.NM_KAPAL,a.VOYAGE_IN,a.VOYAGE_OUT,a.NO_UKK, a.NO_BOOKING, 	   
		...
		$query_list		= "select VESSEL, ID_VSB_VOYAGE, VOYAGE_IN, VOYAGE_OUT, TO_CHAR(to_date(OPEN_STACK,'YYYYMMDDHH24MISS'), 'DD-MM-YYYY HH24:Mi') OPEN_STACK, 
                            ...
                            to_date(CLOSSING_TIME,'YYYYMMDDHH24MISS')
                            from M_VSB_VOYAGE
                            WHERE sysdate BETWEEN TO_DATE(OPEN_STACK,'YYYYMMDDHH24MISS')
                                            and TO_DATE(CLOSSING_TIME,'YYYYMMDDHH24MISS')";
