...
<?php
	...
	{
		$no_req	= $_GET["no_req"];
		$query_rel = "SELECT REQUEST_RELOKASI.*, V_MST_PBM.NM_PBM, YARD_AREA2.NAMA_YARD NAMA_YARD_ASAL, YARD_AREA1.NAMA_YARD NAMA_YARD_TUJUAN FROM REQUEST_RELOKASI 
                      ...
                      INNER JOIN V_MST_PBM ON REQUEST_RELOKASI.KD_EMKL = V_MST_PBM.KD_PBM
