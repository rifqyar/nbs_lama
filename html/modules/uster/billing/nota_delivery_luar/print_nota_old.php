...
//echo $query_nota;die;			   
	...
	$tgl_req	= $result->fetchRow();
       ...
       // echo $tgl_re;die;
		...
		{
			$sql_xpi = "DECLARE id_nota NUMBER; tgl_req DATE; no_request VARCHAR2(100); jenis VARCHAR2 (100); err_msg VARCHAR2(100); BEGIN  id_nota := 4; tgl_req := '$tgl_re'; no_request := '$no_req'; err_msg := 'NULL';jenis := 'delivery'; pack_get_nota_delivery_old.create_detail_nota(id_nota,tgl_req,no_request,jenis, err_msg); END;";
				   //echo $sql_xpi;
			$db->query($sql_xpi);
              //  echo $sql_xpi;die;
		}		
