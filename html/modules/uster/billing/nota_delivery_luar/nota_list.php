<?php
	...
	function cek_nota($no_req)
	{
		...
		if(count($row_cek) > 0)
		{
			...
			{
				echo '<a href="'.HOME.APPID.'/print_nota?no_req='.$no_req.'&koreksi=N" target="_blank"><b> Preview Proforma Gerak</b> </a> <br/><br/>';
				echo '<a href="'.HOME.APPID.'/print_nota_pnkn?no_req='.$no_req.'&koreksi=N" target="_blank"><b> Preview Proforma Penumpukan</b> </a>';
			...
			{
				echo '<a href="'.HOME.APPID.'.print/print_proforma?no_req='.$no_req.'" target="_blank" > Cetak Proforma Gerak</a> ';
                echo " | <a onclick='recalc(\"$req\",\"$notas\")' title='recalculate gerak'><img src='images/money2.png' ></a> <br>";
				echo '<a href="'.HOME.APPID.'.print/print_proforma_pnkn?no_req='.$no_req.'" target="_blank" > Cetak Proforma Penumpukan</a> ';
			...
			{
				echo '<a href="'.HOME.APPID.'.print/print_proforma?no_req='.$no_req.'" target="_blank" > Cetak Proforma Gerak</a> <br/>  <br/> ';		
                echo " | <a onclick='recalc(\"$req\",\"$notas\")' title='recalculate gerak'><img src='images/money2.png' ></a> <br>";
				echo '<a href="'.HOME.APPID.'.print/print_proforma_pnkn?no_req='.$no_req.'" target="_blank" > Cetak Proforma Penumpukan</a> ';
                echo " | <a onclick='recalc_pnkn(\"$req\",\"$notas\")' title='recalculate penumpukan'><img src='images/money2.png' ></a> ";
			}
			...
			{				
				echo '<a href="'.HOME.APPID.'/print_nota?no_req='.$no_req.'&koreksi=Y" target="_blank"><b> Preview Proforma Gerak</b> </a> <br/><br/>';
				echo '<a href="'.HOME.APPID.'/print_nota_pnkn?no_req='.$no_req.'&koreksi=Y" target="_blank"><b> Preview Proforma Penumpukan</b> </a>';		
			}
			else if(($row_cek[0]["NOTA"] <> 'Y') AND ($row_cek[0]["NOTA_PNKN"] == 'Y') AND ($row_cek[0]["KOREKSI"] == 'Y') AND ($row_cek[0]["KOREKSI_PNKN"] == 'Y'))
			{				
				echo '<a href="'.HOME.APPID.'/print_nota?no_req='.$no_req.'&koreksi=Y" target="_blank"><b> Preview Proforma Gerak</b> </a> <br/><br/>';
			...
			{
				echo '<a href="'.HOME.APPID.'/print_nota?no_req='.$no_req.'&koreksi=Y" target="_blank"><b> Preview Proforma Gerak</b> </a> <br/><br/>';
				echo '<a href="'.HOME.APPID.'/print_nota_pnkn?no_req='.$no_req.'" target="_blank"><b> Preview Proforma Penumpukan</b> </a>';	
			}
			else if(($row_cek[0]["NOTA"] == 'Y') AND ($row_cek[0]["NOTA_PNKN"] <> 'Y') AND ($row_cek[0]["KOREKSI"] <> 'Y') AND ($row_cek[0]["KOREKSI_PNKN"] == 'Y'))
			{
				echo '<a href="'.HOME.APPID.'.print/print_proforma?no_req='.$no_req.'" target="_blank" > Cetak Proforma Gerak</a>  ';
