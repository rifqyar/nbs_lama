...
$query="SELECT c.NO_REQUEST, a.NOTA_LAMA, a.NO_NOTA, a.NO_NOTA_MTI, TO_CHAR(a.ADM_NOTA,'999,999,999,999') ADM_NOTA, TO_CHAR(a.PASS,'999,999,999,999') PASS, a.EMKL NAMA, a.ALAMAT  , a.NPWP, c.PERP_DARI, a.LUNAS,a.NO_FAKTUR, TO_CHAR(a.TAGIHAN,'999,999,999,999') TAGIHAN, TO_CHAR(a.PPN,'999,999,999,999') PPN, TO_CHAR(a.TOTAL_TAGIHAN,'999,999,999,999') TOTAL_TAGIHAN, a.STATUS, TO_CHAR(c.TGL_REQUEST,'dd/mm/yyyy') TGL_REQUEST,
       CONCAT(TERBILANG(a.TOTAL_TAGIHAN),'rupiah') TERBILANG, a.NIPP_USER, mu.NAME, CASE WHEN TRUNC(TGL_NOTA) < TO_DATE('1/6/2013','DD/MM/RRRR')
        THEN a.NO_NOTA
        ELSE A.NO_FAKTUR END NO_FAKTUR_, F_CORPORATE_DUMMY_DUMMY(c.TGL_REQUEST) CORPORATE
...
/*Fauzan modif materai 24 Agustus 2020*/
...
/*end Fauzan modif materai 24 Agustus 2020*/
// REMARKED BY YOSUA CHRISTIANOV ITSD (24/09/2020) BUGFIXING PROFORMA TIDAK ADA NO REQ PEMBATAS - INC2020/9/006945
...
//                                             WHERE d.NO_REQUEST = '$no_req') AND a.KETERANGAN NOT IN ('ADMIN NOTA', 'MATERAI')"; /**Fauzan modif 24 Agustus 2020 [NOT IN MATERAI]*/
// REMARKED BY YOSUA CHRISTIANOV ITSD (24/09/2020) BUGFIXING PROFORMA TIDAK ADA NO REQ PEMBATAS - INC2020/9/006945
// EDITED BY YOSUA CHRISTIANOV ITSD (24/09/2020) BUGFIXING PROFORMA TIDAK ADA NO REQ PEMBATAS - INC2020/9/006945
    ...
    $tbl = <<<EOD
            <table border='0'>
              <tr>
                ...
                <tr>
                    <td COLSPAN="6"><b>DELIVERY KE LUAR</b></td>
                </tr>
                <tr>
