 ...
 */
 ...
 $db 	 = getDB("storage");
       ...
       $query_get	= "SELECT c.NO_REQUEST, a.NO_NOTA, TO_CHAR(a.ADM_NOTA,'999,999,999,999') ADM_NOTA, TO_CHAR(a.PASS,'999,999,999,999') PASS, a.EMKL NAMA, a.ALAMAT, a.NPWP, c.PERP_DARI, a.LUNAS,a.NO_FAKTUR, TO_CHAR(a.TAGIHAN,'999,999,999,999') TAGIHAN, TO_CHAR(a.PPN,'999,999,999,999') PPN, TO_CHAR(a.TOTAL_TAGIHAN,'999,999,999,999') TOTAL_TAGIHAN, a.STATUS, TO_CHAR(c.TGL_REQUEST,'dd/mm/yyyy') TGL_REQUEST, CONCAT(TERBILANG(a.TOTAL_TAGIHAN),'rupiah') TERBILANG 
                            FROM nota_stripping a, request_stripping c where
...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		$this->SetY(6);
		$this->Cell(0, 23, $_SESSION["no_nota"], 0, false, 'R', 0, '', 0, false, 'T', 'M');
		$this->SetFont('Courier', 'B', 14);
		$this->SetY(34);
		$this->Cell(0, 15, 'NOTA PERPANJANGAN PENUMPUKAN STRIPPING', 0, false, 'R', 0, '', 0, false, 'T', 'M');
	...
	public function Footer() {
		...
		$this->SetFont('Courier', 'B', 9.5);
		$this->SetY(-115);
		$this->Cell(0, 0, 'Nota sebagai Faktur Pajak berdasarkan Peraturan Dirjen Pajak' , 0, false, 'L', 0, '', 0, false, 'T', 'M');
		$this->SetFont('Courier', 'B', 9.5);
		$this->SetY(-111);
		$this->Cell(0, 0, 'Nomor 10/PJ/2010 Tanggal 9 Maret 2010' , 0, false, 'L', 0, '', 0, false, 'T', 'M');
		...
		$this->SetFont('Courier', 'B I', 9.5);
		$this->SetY(-44);
		$this->SetX(4);
		$this->Cell(0, 0, $_SESSION["terbilang"] , 0, false, '', 0, '', 0, false, 'T', 'M');
		$this->SetFont('Courier', 'B', 9.5);
		$this->SetY(-40);
		$this->Cell(0, 0, 'NOTA PERPANJANGAN PENUMPUKAN STRIPPING' , 0, false, '', 0, '', 0, false, 'T', 'M');
...
/* $pdf->SetMargins($left = 0,
				 ...
				 $right = 0,
				 $keepmargins = false ); */
$pdf->SetMargins('0', '70px', '0','21px');
$pdf->SetHeaderMargin(PDF_MARGIN_HEADER);
$pdf->SetFooterMargin(PDF_MARGIN_FOOTER);
//set auto page breaks
$pdf->SetAutoPageBreak(TRUE, '120px');
        ...
        $tbl4 .=<<<EOD
				...
				Nomor 10/PJ/2010 Tanggal 9 Maret 2010</b></td>
                    ...
                    <tr>
						...
						<tr>
                        <td colspan="2"><b>NOTA PERPANJANGAN PENUMPUKAN STRIPPING</b></td>
                    </tr>
