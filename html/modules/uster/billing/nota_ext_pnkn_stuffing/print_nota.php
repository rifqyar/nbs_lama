<?php
	...
	$query_nota	= "SELECT c.NM_PBM AS EMKL,
                   ...
                   FROM REQUEST_STUFFING b INNER JOIN
                            V_MST_PBM c ON b.KD_CONSIGNEE = c.KD_PBM AND c.KD_CABANG = '05'
...
/* echo "DECLARE
	...
	$total_		  = "SELECT SUM(BIAYA) TOTAL, SUM(PPN) PPN, SUM(BIAYA)+SUM(PPN) TOTAL_TAGIHAN
						...
						WHERE no_request = '$no_req' AND KETERANGAN NOT IN ('MATERAI')"; /**fauzan modif 01 SEP 2020*/;
	...
	/**end modify Fauzan modif 24 Agustus 2020*/
	...
	$total_bayar        = $total_bayar + $bea_materai; /**modify Fauzan 01 September 2020 '+ $bea_materai'*/
	...
	$tl->assign("row_materai",$row_materai); /*Fauzan modif 24 Agustus 2020*/
