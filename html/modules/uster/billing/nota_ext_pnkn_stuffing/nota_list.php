...
//------------------------	
	...
	function cek_nota($no_req)
	{
		...
		if(count($row_cek) > 0)
		{
			...
			{
				echo '<a href="'.HOME.APPID.'.print/print_nota_lunas?no_nota='.$no_nota.'&no_req='.$no_req.'" target="_blank""><b><i> Cetak Proforma </i></b> </a> <br>';
			...
			{
				echo '<a href="'.HOME.APPID.'/print_nota?no_req='.$no_req.'&n=999&koreksi=N" target="_blank"> <b><i> Preview Proforma</i></b></a> ';
			...
			{
				echo '<a href="'.HOME.APPID.'.print/print_proforma?no_req='.$no_req.'" target="_blank"><b><i> Cetak Proforma </i></b></a> <br>';
			}
			else if(($row_cek["NOTA"] == 'Y') AND ($row_cek["KOREKSI"] == 'Y'))
			{
				echo '<a href="'.HOME.APPID.'.print/print_proforma?no_req='.$no_req.'" target="_blank"><b><i> Cetak Proforma </i></b></a> <br>';	
