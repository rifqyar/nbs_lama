...
//echo $query_nota;die;			   
       ...
       // echo $tgl_re;die;
		...
		$sql_xpi = "DECLARE
                    ...
                    begin
						tgl_nota := '$tgl_re';
						no_req   := '$no_req';
						perp_penumpukan(no_req,tgl_nota);
					end;";
        //echo $sql_xpi;die;
	...
	$detail_nota  = "SELECT TO_CHAR(a.TARIF, '999,999,999,999') AS TARIF, a.JML_HARI,  TO_CHAR(a.BIAYA, '999,999,999,999') AS BIAYA, a.KETERANGAN, a.HZ, a.JML_CONT, TO_DATE(a.START_STACK,'dd/mm/yyyy') START_STACK, TO_DATE(a.END_STACK,'dd/mm/yyyy') END_STACK, b.SIZE_, b.TYPE_, b.STATUS FROM temp_detail_nota a, iso_code b WHERE a.id_iso = b.id_iso and a.no_request = '$no_req'";
