...
$pdf->SetFont('Courier', 15,10);
       ...
       $query_get	= "SELECT c.NO_REQUEST, a.NO_NOTA, TO_CHAR(a.ADM_NOTA,'999,999,999,999') ADM_NOTA, TO_CHAR(a.PASS,'999,999,999,999') PASS, a.EMKL NAMA, a.ALAMAT, a.NPWP, c.PERP_DARI, a.LUNAS,a.NO_FAKTUR, TO_CHAR(a.TAGIHAN,'999,999,999,999') TAGIHAN, TO_CHAR(a.PPN,'999,999,999,999') PPN, TO_CHAR(a.TOTAL_TAGIHAN,'999,999,999,999') TOTAL_TAGIHAN, a.STATUS, TO_CHAR(c.TGL_REQUEST,'dd/mm/yyyy') TGL_REQUEST, CONCAT(TERBILANG(a.TOTAL_TAGIHAN),'rupiah') TERBILANG 
                            FROM nota_receiving a, request_receiving c where
...
//        
        ...
        $tbl = <<<EOD
                ...
                <tr>
                    <td COLSPAN="7"></td>
                    <td COLSPAN="7" align="right"><font size="14"><b>NOTA RECEIVING</b></font></td>
                ...
                <tr>
					...
					<th width="70" align="center"><b>TGL AWAL</b></th>
                    <th width="75" align="center"><b>TGL AKHIR</b></th>
...
EOD;
        ...
        $query_get2	= "SELECT a.KETERANGAN, a.JML_CONT, a.JML_HARI, b.SIZE_, b.TYPE_, b.STATUS, a.HZ, TO_CHAR(a.TARIF,'999,999,999,999') TARIF , TO_CHAR(a.BIAYA,'999,999,999,999') BIAYA FROM nota_receiving_d a, iso_code b WHERE a.ID_ISO = b.ID_ISO(+) AND a.NO_NOTA = '$no_nota'";
         ...
         $tbl3 .=<<<EOD
                ...
                <table border='1'>  
                    ...
                    <tr>
                        ...
                        <td width="85" colspan="2" align="right"> - </td>
						<td></td>
                    </tr>
                    <tr>
                        <td colspan="8"></td>
                        <td width="170" colspan="3" align="right">Administrasi :</td>
                        <td width="85" colspan="2" align="right">$adm_nota</td><td></td>
                    </tr>
                    
                    <tr>
                        <td colspan="7"></td>
                        <td width="225" colspan="4" align="right">Dasar Pengenaan Pajak :</td>
                        <td width="85" colspan="2" align="right">$tagihan</td><td></td>
                    </tr>
                    <tr>
                        <td colspan="8"></td>
                        <td width="170" colspan="3" align="right">Jumlah PPN :</td>
                        <td width="85" colspan="2" align="right">$ppn</td><td></td>
                    </tr>
					  <tr>
                        <td colspan="8"></td>
                        <td width="170" colspan="3" align="right">Pass Truck :</td>
                        <td width="85" colspan="2" align="right">$pass</td><td></td>
                    </tr>
                    <tr>
                        <td colspan="8"></td>
                        <td width="170" colspan="3" align="right">Jumlah Dibayar :</td>
                        <td width="85" colspan="2" align="right">$total_tagihan</td><td></td>
                    </tr>
                    </table>
EOD;
        ...
        $tbl4 .=<<<EOD
				...
				Nomor 10/PJ/2010 Tanggal 9 Maret 2010</b></td>
                    ...
                    <tr>
						...
						<tr>
                        <td colspan="2"><b>NOTA RECEIVING</b></td>
                    </tr>
