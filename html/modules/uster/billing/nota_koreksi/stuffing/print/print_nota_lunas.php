...
$pdf->SetFont('Courier', 15,9.5);
       ...
       $query_get	= "SELECT c.NO_REQUEST, a.NO_NOTA, TO_CHAR(a.ADM_NOTA,'999,999,999,999') ADM_NOTA, TO_CHAR(a.PASS,'999,999,999,999') PASS, a.EMKL NAMA, a.ALAMAT, a.NPWP, c.PERP_DARI, a.LUNAS,a.NO_FAKTUR, TO_CHAR(a.TAGIHAN,'999,999,999,999') TAGIHAN, TO_CHAR(a.PPN,'999,999,999,999') PPN, TO_CHAR(a.TOTAL_TAGIHAN,'999,999,999,999') TOTAL_TAGIHAN, a.STATUS, TO_CHAR(c.TGL_REQUEST,'dd/mm/yyyy') TGL_REQUEST, CONCAT(TERBILANG(a.TOTAL_TAGIHAN),'rupiah') TERBILANG 
                            FROM nota_stuffing a, request_stuffing c where
...
//        
        ...
        $tbl = <<<EOD
                ...
                <tr><td COLSPAN="14" align="right"><font size="14"><b>NOTA STUFFING</b></font></td>
...
EOD;
        ...
        $query_get2	= "SELECT TO_CHAR(a.START_STACK,'dd/mm/yyyy') START_STACK,TO_CHAR(a.END_STACK,'dd/mm/yyyy') END_STACK, a.KETERANGAN, a.JUMLAH_CONT, a.JML_HARI, b.SIZE_, b.TYPE_, b.STATUS, a.HZ, TO_CHAR(a.TARIF,'999,999,999,999') TARIF , TO_CHAR(a.BIAYA,'999,999,999,999') BIAYA FROM nota_stuffing_d a, iso_code b WHERE a.ID_ISO = b.ID_ISO(+) AND a.NO_NOTA = '$no_nota'";
        ...
        $tbl4 .=<<<EOD
				...
				Nomor 10/PJ/2010 Tanggal 9 Maret 2010</b></td>
                    ...
                    <tr>
						...
						<tr>
                        <td colspan="2"><b>NOTA STUFFING</b></td>
                    </tr>
