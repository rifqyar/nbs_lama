 ...
 */
 ...
 $db 	 = getDB("storage");
	...
	$row_nota	   = $result->fetchRow();
		...
		//$_SESSION["no_req_baru"] = $no_req_baru;
		$_SESSION["date"] = $dt;
		$_SESSION["PRINTED_BY"] = $nama_lengkap;
		$_SESSION["KET_NOTA"] = "Nota Berlaku Sebagai Pajak Berdasarkan Peraturan Dirjen Pajak PER-13/PJ/2019 Tanggal 2 Juli 2019";
...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		$this->SetFont('Courier', 'B', 14);
		$this->SetY(36);
		$this->Cell(0, 15, 'NOTA BATAL MUAT', 0, false, 'R', 0, '', 0, false, 'T', 'M');
	...
	public function Footer() {
		...
		$this->SetY(-16);
		$this->SetX(50);
		$this->Cell(0, 0, 'NOTA BATAL MUAT' , 0, false, '', 0, '', 0, false, 'T', 'M');
		$this->SetFont('Courier', 'B', 11);
		$this->SetY(-12);
...
//        
        ...
        $tbl = <<<EOD
				...
				<tr>
                    <td width="150" align="left"><b>$teks_baru </b></td>
                    <td>:</td>
                    <td colspan="4">$no_req_baru<b></b></td>
                    <td colspan="8"></td>
                </tr>  
                <tr height="20">
					<td colspan="14"></td>
