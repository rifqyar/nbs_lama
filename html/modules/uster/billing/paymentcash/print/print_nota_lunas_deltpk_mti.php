<?php
//echo 'harap menggunakan cetakan nota dari ict'; die();
//============================================================+
 ...
 */
		...
		$db 	 = getDB("storage");
        global $no_request,$dt,$no_nota_mti,$no_faktur_mti;
        $no_req = $_GET['no_req'];
	...
	//untuk kontainer
		// $qcont = "SELECT A.NO_CONTAINER,A.START_STACK,A.TGL_DELIVERY,B.SIZE_,B.TYPE_ FROM CONTAINER_DELIVERY A, MASTER_CONTAINER B WHERE A.NO_CONTAINER = B.NO_CONTAINER AND A.NO_REQUEST = '$no_req'";
...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		$this->SetFont('', 'B', 12);
		$this->SetY(36);
		$this->Cell(0, 15, $_SESSION["nm_nota"], 0, false, 'C', 0, '', 0, false, 'M', 'M');
		$this->SetFont('', '', 12);
		$this->SetY(42);
		$this->SetX(5);
...
//        
        ...
        $tbl = <<<EOD
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td colspan="4">-</td>
                    <td width="100" align="left">Date Of Stacking </td>
                    <td width="10">:</td>
                    <td width="100">$rc[START_STACK]</td>
				...
				<tr>
                    ...
                    <td>:</td>
                    <td colspan="4">-</td>
                    <td width="100" align="left">Date Of Delivery </td>
                    <td width="10">:</td>
                    <td width="100">$rc[TGL_DELIVERY]</td>
                </tr>
				<tr>
