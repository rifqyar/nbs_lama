 ...
 */
 ...
 $db 	 = getDB("storage");
        ...
        $query_get	= "SELECT c.NO_REQUEST, a.NO_NOTA, a.NOTA_LAMA, TO_CHAR(a.ADM_NOTA,'999,999,999,999') ADM_NOTA, TO_CHAR(a.PASS,'999,999,999,999') PASS, a.EMKL NAMA, a.ALAMAT, a.NPWP, c.PERP_DARI, a.LUNAS,a.NO_FAKTUR, TO_CHAR(a.TAGIHAN,'999,999,999,999') TAGIHAN, TO_CHAR(a.PPN,'999,999,999,999') PPN, TO_CHAR(a.TOTAL_TAGIHAN,'999,999,999,999') TOTAL_TAGIHAN, a.STATUS, TO_CHAR(c.TGL_REQUEST,'dd/mm/yyyy') TGL_REQUEST, 
		CONCAT(TERBILANG(a.TOTAL_TAGIHAN),'rupiah') TERBILANG, mu.NAMA_LENGKAP, CASE WHEN TRUNC(TGL_NOTA) < TO_DATE('1/6/2013','DD/MM/RRRR')
		THEN a.NO_NOTA
		ELSE A.NO_FAKTUR END NO_FAKTUR_ 
                            FROM nota_delivery a, request_delivery c, master_user mu where
...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		$this->SetFont('Courier', 'B', 14);
		$this->SetY(36);
		$this->Cell(0, 15, 'LAMPIRAN NOTA PERPANJANGAN DELIVERY', 0, false, 'R', 0, '', 0, false, 'T', 'M');
	...
	public function Footer() {
		...
		$this->SetY(-16);
		$this->SetX(50);
		$this->Cell(0, 0, 'NOTA PERPANJANGAN DELIVERY' , 0, false, '', 0, '', 0, false, 'T', 'M');
		$this->SetFont('Courier', 'B', 11);
		$this->SetY(-12);
...
EOD;
			 ...
			 AND c.TGL_NOTA = (SELECT MAX(d.TGL_NOTA) FROM NOTA_DELIVERY d WHERE d.NO_REQUEST = '$no_req') AND a.KETERANGAN <> 'ADMIN NOTA' ";
...
// EOD;
        ...
        $pdf->Output('nota_perp_delivery.pdf', 'I');
