...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		$this->SetFont('Courier', 'B', 14);
		$this->SetY(36);
		$this->Cell(0, 15, 'LAMPIRAN NOTA RECEIVING', 0, false, 'R', 0, '', 0, false, 'T', 'M');
...
EOD;
        ...
        $query_get2	= "SELECT a.KETERANGAN,
                               a.JML_CONT,
                               a.JML_HARI,
                               b.SIZE_,
                               b.TYPE_,
                          ...
                          FROM nota_all_d a, iso_code b
                         WHERE     a.ID_ISO = b.ID_ISO(+)
                               AND a.KETERANGAN <> 'ADMIN NOTA'
                               AND a.id_faktur = '$no_nota'";
