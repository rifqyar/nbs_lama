	...
	$to     = $_POST["to"];
        ...
        $db = getDB("storage");
            	...
            	{   
                                        ...
                                        {
                                                $query_list     = "SELECT request_delivery.no_request,
														         tgl_request,
														         pbm.nm_pbm,
														         vessel,
														         voyage,
														         jn_repo,
														         count(no_container) jum_cont
														    FROM request_delivery, container_delivery, kapal_cabang.mst_pbm pbm
														   WHERE     kd_emkl = pbm.kd_pbm 
														         AND request_delivery.no_request = container_delivery.no_request
														         AND delivery_ke = 'TPK'
														         --AND tgl_request BETWEEN SYSDATE - INTERVAL '15' DAY AND SYSDATE
