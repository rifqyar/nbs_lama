<?php
	...
	BLOCKING_AREA.NAME BLOK_, PLACEMENT.SLOT_ SLOT, PLACEMENT.ROW_ ROW_, PLACEMENT.TIER_ TIER,
		...
		$q_detail="SELECT * FROM  (SELECT CONTAINER_STRIPPING.NO_CONTAINER,CONTAINER_STRIPPING.NO_REQUEST,SIZE_,TYPE_,NO_REQUEST_RECEIVING,
                   ...
                   (SELECT MAX(PERP_KE) FROM REQUEST_STRIPPING R, CONTAINER_STRIPPING C WHERE R.NO_REQUEST = C.NO_REQUEST AND C.NO_CONTAINER = CONTAINER_STRIPPING.NO_CONTAINER) MAX_PERP, REQUEST_STRIPPING.CONSIGNEE_PERSONAL PERSONAL
		...
		$jum = count($r_de);
		$tl->assign('jum_real',$jum);
		/*$q_detail = "SELECT DISTINCT CONTAINER_STRIPPING.NO_CONTAINER , REQUEST_STRIPPING.NO_REQUEST , REQUEST_STRIPPING.TGL_REQUEST,  V_MST_PBM.NM_PBM, 'STRIPPING' KEGIATAN, CONTAINER_STRIPPING.TGL_APPROVE, LOKASI_TPK,REQUEST_STRIPPING.CONSIGNEE_PERSONAL,
                       CONTAINER_STRIPPING.TGL_REALISASI, PLACEMENT.TGL_PLACEMENT, MASTER_CONTAINER.SIZE_, MASTER_CONTAINER.TYPE_, '' NM_KAPAL, '' VOYAGE, REQUEST_STRIPPING.NO_REQUEST_RECEIVING, BLOCKING_AREA.NAME BLOK_, BLOCKING_AREA.NAME SLOT_, PLACEMENT.ROW_ ROW_, PLACEMENT.TIER_ TIER
                       ...
                       WHERE REQUEST_STRIPPING.KD_CONSIGNEE = '$kd_pbm' AND TGL_REALISASI IS NULL
					   ORDER BY CONTAINER_STRIPPING.NO_CONTAINER"; 		*/
