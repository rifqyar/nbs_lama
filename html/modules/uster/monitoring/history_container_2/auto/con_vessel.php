<?php
	...
	$q_detail = "SELECT A.NO_UKK, A.NM_KAPAL, A.VOYAGE_IN, A.VOYAGE_OUT, A.NO_BOOKING, '' BP_ID FROM v_booking_stack_tpk A
				JOIN PETIKEMAS_CABANG.TTH_CONT_BOOKING TB ON A.NO_UKK = TB.NO_UKK
				WHERE TB.NO_BOOKING = '$no_book'
				UNION
				SELECT  A.NO_UKK, A.NM_KAPAL, A.VOYAGE_IN, A.VOYAGE_OUT, '' NO_BOOKING, TM.BP_ID FROM v_booking_stack_tpk A
