...
header("Expires: 0");
	...
	$query_list_ 	= "SELECT a.NAME, b.NO_CONTAINER, b.SLOT_, b.ROW_, b.TIER_, c.SIZE_, c.TYPE_, b.STATUS, d.NAMA_YARD, TO_CHAR(b.TGL_PLACEMENT,'dd/mm/yyyy') TGL_PLACEMENT, (TO_DATE(SYSDATE,'dd/mm/yyyy')-TO_DATE(b.TGL_PLACEMENT,'dd/mm/yyyy')) DWEL
	FROM BLOCKING_AREA a, PLACEMENT b, MASTER_CONTAINER c, YARD_AREA d
