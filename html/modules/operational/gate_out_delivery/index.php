...
function js_created()
{
	var url	= "<?=HOME?>operational.gate_out_delivery.auto/save";
	...
	$.post(url,{NO_CONT: my_cont, REQ_DEV: my_req, NO_POL:n_p,REMARK:remarkc,NO_UKK:my_ukk,SEAL:seal_no},function(data) 
	{
		console.log(data);
		/*
		if (data=='sukses')
...
<div class="content" id="finds">
	<p>
	<h2> <img src="<?=HOME?>images/truckyellow1.png" height="5%" width="5%" style="vertical-align:middle">&nbsp;<font color="#0378C6">Delivery</font> Gate-Out</h2></p>
	...
	<tr>
	 ...
	 <tr>
		...
		<td class="form-field-caption" align="right">:</td>
		<td><input type="text" readonly='readonly' size="20" name="tgl_gate_out" id="tgl_gate_out" value="<?=date('d-m-Y H:i:s')?>" />
		</td>
     </tr>
	 <tr>
