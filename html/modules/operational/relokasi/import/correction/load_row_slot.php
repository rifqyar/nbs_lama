...
<div id="mapping2w2">
	...
	?> <tr>
		...
		?>
			<td style="width:40px;height:40px;font-size:8px; font-family:Tahoma; border:1px solid #ffffff;background-color:#86BCFF;" align="center" onMouseOver="this.style.backgroundColor='#CCFF33'" onMouseOut="this.style.backgroundColor='#86BCFF'" onclick="relocate_cont(<?=$yard?>,<?=$block?>,<?=$slot?>,<?=$i?>,<?=$t?>)">
			&nbsp;</td>
	<?}
	}?></tr><?$t--;
	}
