...
function sync_plg()
{
	var url="<?=HOME;?>request.behandle.ajax/sync_pelanggan";
	...
	<table>
		...
		<tr>
			...
			<td class="form-field-caption" align="right"> : </td>
			<td class="form-field-caption" align="left">
				<input type="text" name="paid_thru" id="paid_thru" size="15" maxlength="9" ReadOnly />
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="form-field-caption" align="right"> : </td>
			<td class="form-field-caption" align="left">
				<input type="text" name="emkl" id="emkl" size="30" placeholder="Autocomplete"/>&nbsp;&nbsp;<button onclick="sync_plg()"><img border="0" src="images/Refresh2.png" height="12px" width="12px" title="sync pelanggan" /></button>
