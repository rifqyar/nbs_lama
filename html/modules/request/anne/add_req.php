...
function create_req()
{
	...
	else if( receiving_via=='-')
	{
		alert('Receiving Via Harus Diisi,..');
		return false;
	}
	else
	{
		//alert('e');
		$.post(url,{UKK: ukk,IDEMKL:iemkl,IDEMKL2:iemkl2, IPOD:ipod, IPOL:ipol, SHIP:ship, NPE:npe, PEB:peb, DS:book_ship_h, CAR:icar, START_SHIFT: start_shift, END_SHIFT:end_shift, JML_SHIFT:jml_shift, FIPOD:fipod, receiving_via:receiving_via},function(data){
			//alert(data);
			var row_data = data;
...
<div class="content">
	...
	<tr>
		...
		<td class="form-field-caption" align="right">:</td>
		<td><input type="text" size="25" name="emkl2" id="emkl2" style="background-color:#FFFFCC;" />
	 ...
	 <tr>
		<td class="form-field-caption" align="right"> Receiving Via : </td>
		<td class="form-field-caption" align="right"> : </td>
		<td>
		 <select id="receiving_via">
