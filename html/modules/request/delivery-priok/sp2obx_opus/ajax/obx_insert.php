...
{
	// added by dama 27/11/2014
	// tambah validasi SP2
	var idvsb =  $("#id_vsb").val();
	
	if (idvsb == ""){
		alert('Vessel Opus Harus diisi');
	} else {
		...
		$('#loadobx').load("<?=HOME?>request.delivery.sp2obx_opus.ajax/load_obx?idplp="+v_idplp+"&setoption=1&noukk="+idvsb);
	}
}
