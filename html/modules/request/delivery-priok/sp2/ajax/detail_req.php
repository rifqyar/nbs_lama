...
$(document).ready(function() 
{
	...
	$( "#nc" ).autocomplete({
		minLength: 6,
		source: "request.delivery.sp2.auto/container?ship=<?=$ship;?>&call_sign=<?=$call_sign;?>&vin=<?=$vin;?>",
...
<tr>
		...
		<td colspan="7" ><input type="checkbox" id="bypass_valid_obx" name="bypass_valid_obx">ByPass OBX<br></td>
</tr>
<tr>
