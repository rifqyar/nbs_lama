...
if($row_cek['JML']>0){
	...
	$list_param = $user."^".$idplp."^".$custno."^".$custnm."^".$custadr."^".$custtax."^".$tgldel."^".$row_pkk['CALL_SIGN']."^".$row_pkk['VESSEL']."^".$row_pkk['VOYAGE_IN']."^".$row_pkk['VOYAGE_OUT']."^".$row_pkk['ATA']."^".$row_pkk['ATD']."^".$no_ukk."^".$idplp."^".$tglspjm;
