...
$pli			= $_POST['PLI'];
$plo			= $_POST['PLO'];
$dischdate		= $_POST['dischdate'];
$contdeldate	= $_POST['contdeldate'];
...
if ($rwcek_ob['JUM'] == 0) {
	...
	$param_b_var= array(	
							...
							"v_pli"=>"$pli",
							"v_plo"=>"$plo",
							"v_dischdate"=>"$dischdate",
							"v_contdeldate"=>"$contdeldate",
							"v_msg"=>""
	...
	*/
	...
	:v_ow,:v_ol,:v_oh,:v_unnumber,:v_pod,:v_pol,:v_pli,:v_plo,:v_dischdate,:v_contdeldate,:v_msg); end;";
