...
<?
	...
	$cek_plp = "SELECT NO_REQUEST AS ID_REQ, VESSEL, VOY_IN||'-'|| VOY_OUT AS VOYAGE FROM BIL_DELOB_H WHERE TRIM(ID_DEL) = TRIM('$iddel')";
			...
			<tr>
				...
				<p>
					...
					<table>
						...
						<?								
								$query = "SELECT NO_CONT, LINE_NUMBER FROM BIL_DELOB_D WHERE TRIM(ID_DEL) = TRIM('$iddel')";
