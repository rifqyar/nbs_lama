...
if($row_cek['JML']>0){
	...
	$list_param = $user."^".$idplp."^".$custno."^".$custnm."^".$custadr."^".$custtax."^".$tglspjm."^".$row_pkk['CALL_SIGN']."^".$row_pkk['NM_KAPAL']."^".$row_pkk['VOYAGE_IN']."^".$row_pkk['VOYAGE_OUT']."^".$row_pkk['TGL_JAM_TIBA']."^".$row_pkk['TGL_JAM_BERANGKAT']."^".$no_ukk."^".$idplp."^".$tglspjm;
	/*
	...
	*/
	$sql_apph = "begin proc_sp2spjm_manual_h('$list_param'); end;";
	//print_r($sql_apph);
	//die();
	$db->query($sql_apph);
