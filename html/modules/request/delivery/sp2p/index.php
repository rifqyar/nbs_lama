...
jQuery(function() {
 jQuery("#l_delivery_p").jqGrid({
	...
	mtype : "post",
	datatype: "json",
	colNames:['Status','Aksi','No Request','Old Request','Perp Ke-','Qty','EMKL','Vessel - Voy','Tipe Req'], 
	colModel:[
		{name:'status', width:100, align:"center",sortable:false,search:false},
		...
		{name:'sp2p_ke',index:'sp2p_ke', width:50, align:"center"},
		{name:'jum_cont',index:'jum_cont', width:40, align:"center"},		
