...
$id = $_GET['id'];
$db = getDB();
$query="SELECT DISTINCT VOYAGE_IN, VOYAGE_OUT, VESSEL, EMKL, SHIPPING_LINE, TGL_BERANGKAT2, ALAMAT, NPWP, JENIS, A.STATUS, KODE_PBM, B.TGL_STACK, B.NO_UKK, KET, A.CUSTOM_NUMBER,NPE,PEB,BOOKING_NUMB FROM REQ_BATALMUAT_H A LEFT JOIN REQ_BATALMUAT_D B ON A.ID_REQ=B.ID_REQ WHERE A.ID_REQ='".$id."'"; 
// echo $query;die;
...
?>
		...
		<tr>
			<td colspan="3" align="center">
				...
				<!--<input type="button" name="Edit Request Batalmuat Alih Kapal" value="&nbsp;Edit&bsp;" onclick="valid_edit('tableedit','<?=$id?>')"/>-->
			</td>
		</tr>
	</table>		