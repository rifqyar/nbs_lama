...
$id = $_GET['id'];
$db = getDB();
$query="SELECT DISTINCT VOYAGE_IN, VOYAGE_OUT,VESSEL, EMKL, SHIPPING_LINE, TGL_BERANGKAT2, ALAMAT, NPWP, JENIS, A.STATUS, KODE_PBM, B.TGL_STACK, B.NO_UKK, KET, A.CUSTOM_NUMBER FROM REQ_BATALMUAT_H A LEFT JOIN REQ_BATALMUAT_D B ON A.ID_REQ=B.ID_REQ WHERE A.ID_REQ='".$id."'";
// echo $query;die;
...
?>	
	...
	<table>
		...
		<tr>
			...
			<td class="form-field-caption" align="right"> : </td>
			<td class="form-field-caption" align="left">
				<input type="text" name="vessel" id="vessel" size="30" placeholder="Autocomplete" value="<?=$row['VESSEL']?>" /> / <input type="text" name="voyage_in" id="voyage_in" size="10"  value="<?=$row['VOYAGE_IN']?>"ReadOnly /><input type="text" name="voyage_out" id="voyage_out" size="10"  value="<?=$row['VOYAGE_OUT']?>"ReadOnly />
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="form-field-caption" align="left">
				...
				<input type="hidden" name="kode_pbm" id="kode_pbm" value="<?=$row['KODE_PBM']?>" size="50" ReadOnly />
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="form-field-caption" align="right"> : </td>
			<td class="form-field-caption" align="left">
				<input type="text" name="tgl_delivery" id="tgl_delivery"  value="<?=$row['TGL_BERANGKAT2']?>"size="30" />
			</td>
		</tr>
		<tr>
			<td colspan="3">
...
<?php
$sql2 = "SELECT * FROM REQ_BATALMUAT_D WHERE ID_REQ='".$id."'";
$rs2 = $db->query( $sql2 );
// echo $sql2;
$j=0;
