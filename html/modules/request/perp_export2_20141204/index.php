...
function add_req()
{
	$('#stack_ext').load("<?=HOME?>request.perp_export2.ajax/add_req").dialog({closeOnEscape: false, modal:true, height:300,width:500, title : "Submit Stacking Extension", open: function(event,ui){$(".ui-dialog-titlebar-close",ui.dialog).hide();}});
}
</script>
