...
$id = $_GET['id'];
$db = getDB();
$query="SELECT ID_REQ,EI, NO_EX_CONTAINER, NO_CONTAINER, SIZE_CONT, TYPE_CONT, STATUS_CONT, STATUS, VESSEL, VOYAGE_IN, NO_UKK, PELANGGAN,KD_PELANGGAN, ALAMAT, NPWP, REMARKS, BIAYA, OI FROM REQ_RENAME WHERE ID_REQ ='$id'";
//echo $query;die;
	...
	<table>
		...
		<tr>
			...
			<td class="form-field-caption" align="left">
				<?php if ($row['EI']=='E'){?>
				<input type="text" name="ei" id="ei" value="Eksport" size="20" readonly />
				<?php } else {?>
				<input type="text" name="ei" id="ei" value="Import" size="20" readonly /> <?php } ?> </td>
		</tr>
		<tr>
			...
			<td class="form-field-caption" align="right">:</td>
				...
				<select id="tipe_oi" name="tipe_oi">
					...
					<?php if ($row['OI']=='O'){?>
						<option value="O" selected>Ocean Going</option>
						<option value="I">Intersuler</option>
					<?php } else {?>
						<option value="O">Ocean Going</option>
						<option value="I" selected>Intersuler</option>
					<?php } ?> </td>
				</select>		
			</td>
        </tr>    
		<tr>
			...
			<td class="form-field-caption" align="left">
				...
				<input type="hidden" name="no_rename" id="no_rename" value="<?=$row['ID_REQ'];?>" size="20" readonly />
			</td>
		</tr>
		<tr>
			...
			<td class="form-field-caption" align="right"> : </td>
			<td class="form-field-caption" align="left">
				<input type="text" name="no_cont" id="no_cont" size="20" value="<?=$row['NO_CONTAINER'];?>" readonly />
			</td>
		</tr>
		...
		<tr>
			...
			<td class="form-field-caption" align="right"> : </td>
			<td class="form-field-caption" align="left">
				<input type="text" name="size_" id="size_" size="8" value="<?=$row['SIZE_CONT'];?>" readonly /> - <input type="text" name="type_" id="type_" value="<?=$row['TYPE_CONT'];?>" size="8" readonly /> - <input type="text" name="status" id="status" size="8" value="<?=$row['STATUS_CONT'];?>" readonly /> 
			</td>
		</tr>
		<tr>
			...
			<td class="form-field-caption" align="right"> : </td>
			<td class="form-field-caption" align="left">
				<input type="text" name="vessel" id="vessel" size="30" value="<?=$row['VESSEL'];?>" readonly /> / <input type="text" name="voyage_in" id="voyage_in" size="10" value="<?=$row['VOYAGE_IN'];?>" ReadOnly />
			</td>
		</tr>
		<tr>
...
<tr>
			...
			<td class="form-field-caption" align="left" valign="top">
				<input type="text" name="custname" id="custname" size="20" value="<?=$row['PELANGGAN'];?>"  /> - <input type="text" name="custid" id="custid" size="10"  value="<?=$row['KD_PELANGGAN'];?>"/>
			</td>
		</tr>
		<tr>
