...
<?php
	$db=getDb();
	$req=$_GET['no_req'];
	$qr="SELECT SHIPPING_LINE, ALAMAT, NPWP, VESSEL_OLD, VOYAGE_IN_OLD, E_I, TGL_REQUEST, NO_UKK_OLD, USER_REQ, STATUS, NO_BC_12, NO_SURAT_TRS, VESSEL_NEW, VOYAGE_IN_NEW, NO_UKK_NEW, KD_PELANGGAN, OI, DECODE(OI,'O','Ocean Going','I','Intersuler') AS KET_OI, KETERANGAN from REQ_TRANSHIPMENT_H A WHERE ID_REQ='$req'";
	//print_r($qr);die;
	$er=$db->query($qr);
	$hr=$er->fetchRow();
?>
