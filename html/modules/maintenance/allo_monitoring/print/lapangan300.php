			...
			<table border='1'>
				...
				<?php
					...
					foreach ($data as $row){
						...
						foreach ($data3 as $de){
							$detail .= "<td width='20'>".$de['SIZE_CONT']."</td><td width='32'> ".$de['TYPE_CONT']."</td><td width='35'> ".$de['STATUS_CONT']."</td><td width='20'> ".$de['HZ']." </td><td width='36'>".$de['HEIGHT']." </td><td width='40'>".$de['TYPE_REFFER']."</td><td width='30'>".$de['BOX']."</td></tr>";
						}
						$detail .= '</table>';
