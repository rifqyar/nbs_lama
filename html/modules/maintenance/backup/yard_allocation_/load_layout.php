...
<table width="200%" cellspacing="3" border="0">
<tbody>
<tr>
        ...
        //   echo "SELECT WIDTH, ID FROM YD_YARD_AREA WHERE STATUS = 'STATUS'";die;
         ...
         // debug($blok2);die;
            foreach ($blok2 as $row){
                ...
                // echo " SELECT COUNT(ID_PLACEMENT) JUM FROM YD_PLACEMENT_YARD WHERE ID_BLOCKING_AREA = '$id_block' AND SLOT_YARD = '$slot_' AND ROW_YARD = '$row_' AND ID_CELL = '$index_cell_' ";
                    ...
                    // debug($place);die;
                     ...
                     if (($size_ == '40') && ($type_ == 'DRY')){ ?>
                            <td onMouseOver="this.style.backgroundColor='#CCFF33'" onMouseOut="this.style.backgroundColor='#86BCFF'" align="center" style="width:20px;height:30px;font-size:8px; font-family:Tahoma; background-image:url('yard/src/css/excite-bike/images/ui-bg_diagonals-thick_95_ffdc2e_40x40.png'); background-size:10px 5px"><?=$kategori2?></td>
                   <?     } else if (($size_ == '40') && ($type_ == 'HQ')){ ?>
                           <td onMouseOver="this.style.backgroundColor='#CCFF33'" onMouseOut="this.style.backgroundColor='#86BCFF'" align="center" style="width:20px;height:30px;font-size:8px; font-family:Tahoma; background-image:url('yard/src/css/excite-bike/images/ungu.png'); background-size:10px 5px"><font color="#ffffff"><?=$kategori2?></font></td>
                   ...
                   <?     } else if (($size_ == '45') && ($type_ == 'DRY')){?>
                           <td onMouseOver="this.style.backgroundColor='#CCFF33'" onMouseOut="this.style.backgroundColor='#86BCFF'" align="center" style="width:40px;height:30px;font-size:8px; font-family:Tahoma;background-image:url('yard/src/css/excite-bike/images/ui-bg_diagonals-thick_18_b81900_40x40green.png'); background-size:10px 5px"><font color="#ffffff"><?=$kategori2?></font></td>
                   <?    } else if (($size_ == '45') && ($type_ == 'HQ')){ ?>
                            <td onMouseOver="this.style.backgroundColor='#CCFF33'"  onMouseOut="this.style.backgroundColor='#86BCFF'" align="center" style="width:40px;height:30px;font-size:8px; font-family:Tahoma;background-image:url('yard/src/css/excite-bike/images/ui-bg_diagonals-thick_18_b81900_40x40green.png');background-size:10px 5px"><?=$kategori2?></td>
               ...
               <? } } else {?>
                    <td align="center" style="width:10px;height:5px;font-size:2px; font-family:Tahoma; border:1px solid #000000;"></td>
              <? }
