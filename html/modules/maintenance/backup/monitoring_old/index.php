            ...
            foreach ($blok2 as $row){
                ...
                // echo " SELECT COUNT(ID_PLACEMENT) JUM FROM YD_PLACEMENT_YARD WHERE ID_BLOCKING_AREA = '$id_block' AND SLOT_YARD = '$slot_' AND ROW_YARD = '$row_' AND ID_CELL = '$index_cell_' ";
                   ...
                   // echo $placement;
                     if ($placement <> 0){ ?>
                          <div id="x" class="drag blue">
                          <td data-tooltip="sticky1" onMouseOver="this.style.backgroundColor='#CCFF33'" onMouseOut="this.style.backgroundColor='#FF0033'" align="center" style="width:30px;height:10px;font-size:8px; font-family:Tahoma; border:1px solid #000000;background-color:#FF0033; "><?= $index_cell_?><?echo $placement ?></td>
                         </div>
                   <?  } else { ?>
                             <div id="x" class="drag blue">
                          <td data-tooltip="sticky1" onMouseOver="this.style.backgroundColor='#CCFF33'" onMouseOut="this.style.backgroundColor='#86BCFF'" align="center" style="width:30px;height:10px;font-size:8px; font-family:Tahoma; border:1px solid #000000;background-color:#86BCFF; "><?=$index_cell_?><?echo $row['NAME']?></td>
                                                   </div>
