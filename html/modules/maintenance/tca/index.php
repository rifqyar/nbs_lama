...
<div class="content">
	<div class="main_side">
		...
		<div style="text-align:center;margin-bottom:40px;margin-top:40px;">
			...
			<input type="text" name="trx_number" id="trx_number" size="20" style="background-color:#FFF;text-align:center;height:30px;font-size:20pt;" />
			<br />
			<br />
