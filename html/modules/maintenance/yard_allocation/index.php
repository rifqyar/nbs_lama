...
<br>
<div style="margin-top:0px;border:1px solid black;width:550;height:610;overflow-y:scroll;overflow-x:scroll;">
<span id="select-result" style="display: none;"></span>
<span id="result"></span>
<div class="grid" style="float:left">
	<br />
                         &nbsp  &nbsp &nbsp <font size=4px><font color="red"><b>BLOK <?php echo $name?></b></font></font>
                       <br /><br /><br /><br />
						  <center>
