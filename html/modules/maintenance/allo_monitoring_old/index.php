...
function print()
{
	...
	{
		window.open('<?=HOME?>maintenance.allo_monitoring.print/yd_layout/?id_yard='+yd_id,'_blank');
	}	
	else if(yd_select=='all2')
	{
		window.open('<?=HOME?>maintenance.allo_monitoring.print/lapangan300/?id_yard='+yd_id+'&voyage='+voyage+'&vessel='+vessel,'_blank');
	}
	else if(yd_select=="")
	{
