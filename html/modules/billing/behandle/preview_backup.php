<?php
 ...
 $db=  getDB();
	...
	$db->query($sql_xpi);
	$query_nota	= "SELECT a.EMKL AS EMKL, a.ALAMAT_EMKL AS ALAMAT, a.NPWP, a.VESSEL, a.VOYAGE_IN, TO_CHAR(a.TGL_REQUEST,'dd-mm-yyyy') TGL_REQUEST FROM REQ_BEHANDLE_H a WHERE a.ID_REQ = '$no_req'";
