...
$data = $db->query($query)->fetchRow();
 ...
 //Nama Perusahaan
		/*ipctpk*/
		//$qnama = "select fc_nm_perusahaan('$param_tgl', 'TRANSHIPMENT') NM_PERUSAHAAN from dual";    
...
$query_dtl="SELECT A.*,C.*, to_char(A.TARIF,'999,999,999,999,999.00') AS TARIFN, to_char(A.SUB_TOTAL,'999,999,999,999,999.00') AS SUB_TOTALN 
            FROM NOTA_TRANSHIPMENT_D A, NOTA_TRANSHIPMENT_H B, MASTER_BARANG C WHERE A.ID_PROFORMA='$nota_trans'  AND A.ID_PROFORMA=B.ID_PROFORMA AND C.KODE_BARANG=A.ID_CONT";
...
$query_jum="SELECT COUNT(1) JUM_DETAIL FROM NOTA_TRANSHIPMENT_D A WHERE A.ID_PROFORMA='$nota_trans'";
...
for($pg=1; $pg<=$jum_page; $pg++) {
	...
	$tbl = <<<EOD
		...
		<tr style="font-weight:bold">                    
                 ...
                 <td><font size="8">$data[ID_USER] <b>|</font> <font size="5"></b> $date</font></td>
                </tr> 
                <tr style="font-weight:bold">                    
...
<table>                                                             
        ...
        <tr style="font-weight:bold">
                ...
                <br>
                <br><font size="8"><b>$rname</font><br>
