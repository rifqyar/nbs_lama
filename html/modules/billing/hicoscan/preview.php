<?php
 ...
 $sql_xpi = "DECLARE no_req VARCHAR2(50); BEGIN no_req :='".$no_req."'; nota_hicoscan(no_req); END;";
		...
		$query_nota	= "SELECT a.EMKL AS EMKL, a.ALAMAT_EMKL AS ALAMAT, a.NPWP, to_char(a.TGL_REQUEST,'dd-mm-yyyy') TGL_REQUEST FROM REQ_HICOSCAN a WHERE a.ID_REQUEST = '$no_req'
				   ";
