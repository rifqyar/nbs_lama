...
$query="SELECT ID_NOTA  FROM nota_receiving_h WHERE TRIM(ID_REQ) = TRIM('$no_req') AND STATUS <> 'X'";
...
$query_dtl="SELECT a.KETERANGAN, a.TGL_START_STACK, a.TGL_END_STACK, ROUND(a.JUMLAH_HARI) AS JUMLAH_HARI, a.JUMLAH_CONT, b.UKURAN SIZE_, b.TYPE, b.STATUS, a.HZ, TO_CHAR(a.TARIF,'999,999,999,999') TARIF , TO_CHAR(a.SUB_TOTAL,'999,999,999,999') SUB_TOTAL FROM nota_receiving_d a, master_barang b WHERE a.ID_CONT = b.KODE_BARANG(+) AND a.ID_NOTA = '$notanya' AND a.KETERANGAN<>'ADM'";
...
$query_jum="SELECT COUNT(1) JUM_DETAIL FROM NOTA_RECEIVING_D A WHERE A.ID_NOTA='$notanya'";
