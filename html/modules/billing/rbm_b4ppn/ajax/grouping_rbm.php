...
<script>
	...
	function sbm_rbm()
	{
		...
		if(trade_type == '-'){
			alert ("Tipe Perdagangan harus dipilih");
			return false;
		}
		...
		$.post(url,{TRADE_TYPE:trade_type, KRBM:array, KSF:array2, KHM:array3, ID_VSB:<?=$id_vsb;?>}, function(data)
		{
			console.log(data);
			alert(data);
			$('#hasil').load("<?=HOME?>billing.rbm.ajax/dhasil?id=<?=$id_vsb;?>");
...
<b><?=$ket;?></b>
<br><br>
<p align="left"><b><i>Tipe Perdagangan</i></b></p>
<p align="left">
<select id="trade_type" style="width:150px;font-weight:bold">
