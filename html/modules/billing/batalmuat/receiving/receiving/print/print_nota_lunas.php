...
$query_dtl="SELECT a.KETERANGAN, a.TGL_START_STACK, a.TGL_END_STACK, a.JUMLAH_HARI, a.JUMLAH_CONT, b.UKURAN SIZE_, b.TYPE, b.STATUS, a.HZ, TO_CHAR(a.TARIF,'999,999,999,999') TARIF , TO_CHAR(a.SUB_TOTAL,'999,999,999,999') SUB_TOTAL FROM tb_nota_receiving_d a, master_barang b WHERE a.ID_CONT = b.KODE_BARANG(+) AND a.ID_REQ = '$no_req'";
