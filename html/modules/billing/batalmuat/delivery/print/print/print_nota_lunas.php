...
$query="SELECT ID_NOTA  FROM nota_delivery_h WHERE TRIM(ID_REQ) = TRIM('$no_req')";
...
$query_dtl="SELECT a.KETERANGAN, 
				   ...
				   TO_CHAR(a.SUB_TOTAL,'999,999,999,999') SUB_TOTAL 
		    FROM nota_delivery_d a, master_barang b 
			WHERE a.ID_CONT = b.KODE_BARANG(+) AND a.ID_REQ = '$no_req'";
...
for($pg=1; $pg<=$jum_page; $pg++) {
	...
	$tbl = <<<EOD
			<table border='0'>
                ...
                <tr>
                    <td COLSPAN="6"></td>
                    <td COLSPAN="8" align="right"><font size="11"><b>PENUMPUKAN / GERAKAN (LIFT ON/DELIVERY PETIKEMAS)</b></font></td>
                ...
                <tr>
					...
					<td colspan='8' width="400" align="right">BONGKAR/IMPORT</td>
                </tr>
                <tr>
                    <td COLSPAN="2"></td>
