...
$query="SELECT ID_PROFORMA, TO_CHAR(TGL_REQ,'dd-mm-yyyy') TGL_REQUEST FROM nota_batalmuat_h_penumpukan WHERE TRIM(ID_REQ) = TRIM('$no_req') AND STATUS!='X'";
...
/*PTP*/
	/*ipctpk*/
    //$query = "select fc_nm_perusahaan('$param_tgl','BM') NM_PERUSAHAAN from dual";
...
$query="UPDATE NOTA_BATALMUAT_H_PENUMPUKAN SET TGL_CETAK_NOTA=SYSDATE WHERE ID_PROFORMA='$notanya'";
$db->query($query);
...
$query= "SELECT b.ID_PROFORMA, b.ID_REQ, b.EMKL, b.ALAMAT, b.NPWP, b.TGL_REQ, b.JENIS, b.VESSEL, b.VOYAGE_IN, b.VOYAGE_OUT, to_char(b.BAYAR,'999,999,999,999') AS TOTAL, to_char(b.ADM,'999,999,999,999') as ADM_NOTA, to_char(b.PPN,'999,999,999,999') AS PPN, to_char(b.TOTAL,'999,999,999,999') AS TAGIHAN,
		(SELECT NAME FROM TB_USER a WHERE b.PENGGUNA = a.ID) ID_USER
		 FROM NOTA_batalmuat_h_PENUMPUKAN b
		 WHERE TRIM(b.ID_PROFORMA) = TRIM('$notanya')";
...
/*gagat add materai 12 feb 2020*/
$query_mtr="SELECT A.TOTAL AS BEA_MATERAI
                      FROM NOTA_BATALMUAT_D_PEN_TMP a
                      WHERE  A.ID_REQ = '$no_req' AND A.KETERANGAN='MATERAI'";/**gagat modif 12 feb 2020 NOT IN ('MATERAI')*/
$row_mtr = $db->query($query_mtr)->fetchRow();
...
$query_dtl="SELECT TO_CHAR(a.TARIF, '999,999,999,999') AS TARIF, 
                      ...
                      FROM NOTA_BATALMUAT_D_PEN_TMP a, master_barang b 
                      WHERE a.ID_CONT = b.KODE_BARANG(+) and a.ID_REQ = '$no_req' AND KETERANGAN NOT IN ('ADM','MATERAI')";/**gagat modif 12 feb 2020 NOT IN ('MATERAI')*/
	...
	foreach($row2 as $rows) {
            if($rows[START_STACK]<>''){
                ...
                $detail .= '
		<tr><td colspan="3" width="60"><font size="6">'.'<b>'.$rows[KETERANGAN].'</b>'.'</font></td>
                        ...
                        <td width="15" align="center"><font size="6">'.'<b>'.$rows[HZ].'</b>'.'</font></td>                        
                        <td width="50" align="right"><font size="6">'.'<b>'.$rows[TARIF].'</b>'.'</font></td>                        
                        <td width="50" align="right"><font size="6">'.'<b>'.$rows[SUB_TOTAL].'</b>'.'</font></td>        
                        </tr>   
                <tr><td colspan="8"><font size="6"><i><b>('.$rows[START_STACK].' s/d '.$rows[END_STACK].')'.$rows[JUMLAH_HARI].' hari</i></b></font></td>
                 </tr>
                        ';
...
$query_jum="SELECT COUNT(1) JUM_DETAIL FROM NOTA_BATALMUAT_D_PENUMPUKAN A WHERE A.ID_REQ='$no_req'";
...
for($pg=1; $pg<=$jum_page; $pg++) {
	...
	<table border='0'>                
                <tr>
                    <td colspan="2" align="left"><font size ="10"><b>$data[NO_FAKTUR]</b></font></td>                                    
                </tr>
                <tr>
                    <td align="left"><font size="8"><b>$data[ID_PROFORMA]</b></font></td>                    
                <td colspan="2"> <font size="8"> <b>$date</b></font></td>
                </tr>
                
                <tr>                    
                    <td><b>$data[ID_REQ]</b></td>
                </tr>                                   
                
                <tr>                    
                    <td COLSPAN="1" align="left"><font size="6"><b>BATAL MUAT DELIVERY</b></font></td>                    
                </tr>
                ...
                <tr>                    
                    <td COLSPAN="6" align="left" width="250"><b>$data[ALAMAT]</b></td>					
                </tr>
                <tr>                    
                    <td COLSPAN="4" align="left"><b>$data[VESSEL] / $data[VOYAGE_IN]-$data[VOYAGE_OUT]</b></td>
                    <td colspan="7"></td>
                </tr>                                                  
                <tr>                    
		<td colspan='4' align="left">$data[TGL_BERANGKAT2]</td>
                </tr>
		
   
                <tr>
                    <th colspan="3" width="60"><font size="6"><b>KETERANGAN</b></font></th>
...
<table>                    
                    <tr>
                        ...
                        <td width="100" colspan="4" align="right"><b>0.00</b></td>
                    </tr>
                    <tr>
                        
                        <td colspan="4" align="right"><b>Administrasi :</b></td>
                        <td colspan="4" align="right"><b>$data[ADM_NOTA]</b></td>
                    </tr>
                    <tr>
                      
                        <td colspan="4" align="right"><b>Dasar Peng. Pajak :</b></td>
                        <td colspan="4" align="right"><b>$data[TAGIHAN]</b></td>
                    </tr>
                    <tr>
                        
                        <td colspan="4" align="right"><b>Jumlah PPN :</b></td>
                        <td colspan="4" align="right"><b>$data[PPN]</b></td>
                    </tr>
                    <tr>
                        
                        <td colspan="4" align="right"><b>Jumlah PPN Subsidi :</b></td>
                        <td colspan="4" align="right"><b>0.00</b></td>
                    </tr>
					<!-----gagat modif 12 feB 2020 --->
					<tr>
                        
                        <td colspan="4" align="right"><b>Bea Materai :</b></td>
                        <td colspan="4" align="right"><b>$bea_materai</b></td>
                    </tr>
					<!----gagat modif 12 feb 2020--->
                    <tr>
                     
                        <td colspan="4" align="right"><font size="8"><b>Jumlah Dibayar :</b></font></td>
                        <td colspan="4" align="right"><font size="8"><b>$data[TOTAL]</b></font></td>
                    </tr> 
                    </table>
					<br>
					<br>
