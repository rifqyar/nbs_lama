...
//print_r("SELECT * from TB_NOTA_DELIVERY_D A, TB_NOTA_DELIVERY_H B, MASTER_BARANG C WHERE A.ID_NOTA='$p1'  AND A.ID_NOTA=B.ID_NOTA AND C.KODE_BARANG=A.ID_CONT");die;
 ...
 /**Fauzan start modify amount materai 17 Oktober 2019 **/
	$query_materai="SELECT TRIM ( TO_CHAR (TOTAL, '999,999,999,999')) AS TOTAL FROM NOTA_batalmuat_d WHERE ID_REQ = '$no_req' AND KETERANGAN='MATERAI' ";
...
$query_dtl=" SELECT 
                 ...
                 b.STATUS 
    FROM 
                NOTA_BATALMUAT_D_TMP a, master_barang b 
    WHERE 
                a.ID_CONT = b.KODE_BARANG 
                AND a.ID_REQ = '$no_req' 
                AND KETERANGAN <> 'ADM'
                AND KETERANGAN = 'BATAL MUAT'";
