...
$query_dtl="SELECT TO_CHAR(a.TARIF, '999,999,999,999') AS TARIF, 
	...
	foreach($row2 as $rows) {
		...
		<tr><td colspan="3" width="150"><font size="8">'.$rows[KETERANGAN].'</font></td>
                        <td width="65" align="center"><font size="8">'.$rows[START_STACK].'</font></td>
                        <td width="65" align="center"><font size="8">'.$rows[END_STACK].'</font></td>
...
for($pg=1; $pg<=$jum_page; $pg++) {
	...
	$tbl = <<<EOD
			<table border='0'>
                ...
                <tr>
                    <td COLSPAN="6"></td>
                    <td COLSPAN="8" align="right"><font size="11"><b>PRANOTA PENUMPUKAN / GERAKAN (LIFT ON/DELIVERY PETIKEMAS)</b></font></td>
