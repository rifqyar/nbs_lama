<?php
	...
	$sql_xpi = "BEGIN pkg_delivery_empty_pen.prc_crtmpdel(:NO_REQ,:TIPE_REQ,:V_MSG); END;";
		//echo $sql_xpi;die;
	...
	$detail_nota  = " SELECT 
                          ...
                          FROM 
                                nota_delivery_d_tmp_pen a left join  master_barang b 
	...
	$total_		  = "SELECT SUM(SUB_TOTAL) TOTAL FROM nota_delivery_d_tmp_pen WHERE ID_REQ = '$no_req'";
	//echo $total_ ;die;
    ...
    $adm   			= $jml_cont*10000;
	$query_adm		= "SELECT TO_CHAR(sub_total , '999,999,999,999') AS ADM FROM NOTA_DELIVERY_D_TMP_PEN WHERE id_req = '$no_req' and keterangan='ADM'";
