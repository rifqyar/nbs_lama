...
$query="SELECT A.ID_REQ, NVL (A.ID_PROFORMA, '-') ID_PROFORMA,
			   NVL (A.NO_FAKTUR, '-') NO_FAKTUR, A.ID_USER,
			   TO_CHAR (A.ADM_NOTA, '999,999,999,999') ADM_NOTA, A.EMKL, A.ALAMAT,
			   A.NPWP, TO_CHAR (A.TAGIHAN, '999,999,999,999') TAGIHAN,
...
foreach($row_container as $row_containers) {
 ...
 /**Fauzan start modify amount materai 17 Oktober 2019 **/
	$query_materai="SELECT TRIM ( TO_CHAR (SUB_TOTAL, '999,999,999,999')) AS TOTAL FROM nota_delivery_d WHERE ID_REQ = '$no_req' AND KETERANGAN='MATERAI' ";
