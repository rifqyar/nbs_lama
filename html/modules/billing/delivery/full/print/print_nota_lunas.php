...
$query="SELECT ID_PROFORMA, ID_REQ, TO_CHAR(TGL_REQUEST,'dd-mm-yyyy') TGL_REQUEST FROM nota_delivery_h WHERE TRIM(ID_REQ) = TRIM('$no_req') AND STATUS!='X'";
...
$query="SELECT a.ID_REQ, 
			   ...
			   TRIM (TO_CHAR(a.TOTAL,'999,999,999,999')) TOTAL_MTR,
			   a.STATUS, TO_CHAR (a.TGL_REQUEST, 'dd/mm/yyyy') TGL_REQUEST,
			   (SELECT NAME
				  FROM TB_USER
				 WHERE ID = a.ID_USER) ID_USER, B.VESSEL, B.VOYAGE_OUT AS VOYAGE
...
/**Fauzan start modify amount materai 17 Oktober 2019 **/
	$query_materai="SELECT TRIM ( TO_CHAR (SUB_TOTAL, '999,999,999,999')) AS TOTAL FROM nota_delivery_d WHERE ID_REQ = '$no_req' 
...
$query_dtl="SELECT TO_CHAR (SUM(a.TARIF), '999,999,999,999') AS TARIF,
			   TO_CHAR (SUM(a.SUB_TOTAL), '999,999,999,999') AS SUB_TOTAL,
			   a.TXT_VALUE KETERANGAN,
			   a.HZ,
			   a.JUMLAH_CONT,
			   TO_DATE (a.TGL_START_STACK, 'dd/mm/yyyy') TGL_START_STACK,
			   TO_DATE (a.TGL_END_STACK, 'dd/mm/yyyy') TGL_END_STACK,
			   b.UKURAN SIZE_,
			   b.TYPE,
			   b.STATUS,
			   a.JUMLAH_HARI
		  FROM    nota_delivery_d_tmp a
			   LEFT JOIN
				  master_barang b
...
<table>                    
					...
					<tr>
                        ...
                        <td colspan="6" align="right"><b>Jumlah Materai :</b></td>
                        <td colspan="2" align="right"><b>$bea_materai</b></td>
                    </tr>
                    <tr>
                     
                        <td colspan="6" align="right"><font size="8"><b>Jumlah Dibayar :</b></font></td>
                        <td colspan="2" align="right"><font size="8"><b>$data[TOTAL_MTR]</b></font></td>
                    </tr>               
...
<table> 
                    ...
                    <tr>
                        ...
                        <td colspan="4" align="left"><font size="8"> Rp. <b>$data[TOTAL_MTR]</b></font></td>
                    </tr>               
