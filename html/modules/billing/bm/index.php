...
{
	//alert(a);
    if(confirm("Nota akan ditransfer ke SIMKEU dan release HOLD, apakah anda yakin nota telah valid dan benar? Proses ini tidak bisa rollback")){
