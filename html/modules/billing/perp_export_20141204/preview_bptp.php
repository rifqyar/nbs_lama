<?php
 ...
 //$db->query($sql_xpi);
	...
	/*$db->query("  INSERT INTO NOTA_STACKEXT_D_TMP (TGL_START_STACK,
                                    TGL_END_STACK,
                                    ID_CONT,
                                    HZ,
                                    JUMLAH_CONT,
                                    ...
                                    ID_REQ,
                                    URUT)
      (  SELECT TO_DATE (a.TGL_STACK, 'dd/mm/yyyy') + 5,
                a.TGL_DEPARTURE,
                a.ID_CONT,
                a.HZ,
                COUNT (1) JML,
                ...
                'PENUMPUKAN MASA I.2',
                (SELECT b.TARIF
                   FROM MASTER_TARIF_CONT b
                  WHERE b.ID_CONT = A.ID_CONT AND b.JENIS_BIAYA = 'PENUMPUKAN'),
                COUNT (1) * (a.DURASI - 5)
                * (SELECT b.TARIF
                     FROM MASTER_TARIF_CONT b
                    WHERE b.ID_CONT = A.ID_CONT
                          AND b.JENIS_BIAYA = 'PENUMPUKAN'),
                '$no_req',
                ''
           FROM REQ_STACKEXT_D a
          WHERE a.ID_REQ = '$no_req'
          AND a.DURASI > 5 AND a.DURASI < 10
       GROUP BY TO_DATE (a.TGL_STACK, 'dd/mm/yyyy'),
                a.TGL_DEPARTURE,
                a.ID_CONT,
                a.HZ,
                a.DURASI)");
