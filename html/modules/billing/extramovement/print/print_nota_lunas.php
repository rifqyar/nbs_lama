...
$query="SELECT ID_NOTA  FROM exmo_nota WHERE TRIM(ID_REQUEST) = TRIM('$p01')";
...
$query="INSERT INTO LOG_NOTA (ID_NOTA,NO_REQUEST,KODE_MODUL,KETERANGAN,ID_USER) VALUES ('$notanya','$p01','$kode','CETAK','$id_user')";
		$db->query($query);
$query="UPDATE exmo_nota SET TGL_CETAK_NOTA=SYSDATE WHERE ID_REQUEST='$p01'";
$db->query($query);
...
$qnama = "select fc_nm_perusahaan('$param_tgl', 'EXMO') NM_PERUSAHAAN from dual";
//ECHO $qnama;die;
...
for($pg=1; $pg<=$jum_page; $pg++) {
	...
	$tbl = <<<EOD
			<table>
                <tr>
                    <td COLSPAN="14" align="left"><b>$rname</b></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td COLSPAN="6"></td>
                    <td COLSPAN="8" align="right"><font size="11"><b>PRANOTA EXTRA MOVEMENT</b></font></td>
