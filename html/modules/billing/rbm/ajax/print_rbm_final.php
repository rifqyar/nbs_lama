...
/*PT. PTP*/
	...
	$qnama = "select nm_perusahaan from date_reference where cut_date <= to_date('$param_tgl','dd Mon yy') order by cut_date desc";
...
EOD;
	...
	$tbl .= <<<EOD
					...
					<tr><td colspan="2"></td><td colspan="2" align="center">MANAGER TERMINAL PETIKEMAS</td></tr>
					<tr><td colspan="4"></td></tr>
					<tr><td colspan="4"></td></tr>
					<tr><td colspan="4"></td></tr>
