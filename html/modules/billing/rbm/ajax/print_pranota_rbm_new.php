...
//nambah parameter pelanggan buat pp 74
$kd_pel = $_GET['kd_pel'];										   
...
$p_pranota = array("in_idvsb"   => $id_vsb,
                   ...
                   "in_user"    => $id_user,
                   "id_ictukk"    => $id_ictukk,
				   "in_kd_pel"  => $kd_pel, // tambahan baru				   
                   "in_pnstv"   => "");

$q_pranota = "declare begin prc_bilstvproforma(:in_idvsb,:in_kat,:in_val,:in_user,:id_ictukk,:in_kd_pel,:in_pnstv); end;";
$db->query($q_pranota,$p_pranota);
$idpnstv = $p_pranota['in_pnstv'];

if($valas == 'USD') {
    $query_detail = "SELECT NT_CT KEG, EI, REMARKS OI, TY_CC, SIZE_CONT, TYPE_CONT, STS_CONT, HZ_LABEL, QTY_RPSTV JML, FARE_, 
...
/**gagat start materai 25 JAN 2020*/
$query_mtr = "SELECT TTL_FARE AS BEA_MATERAI
    from bil_pnstv_d where id_pnstv='$idpnstv' AND NT_CT='MATERAI' ";
$rquery_mtr = $db->query($query_mtr);
$rw_mtr = $rquery_mtr->fetchRow();	
if($rw_mtr['BEA_MATERAI']>0){
	$bea_materai = $rw_mtr['BEA_MATERAI'];
}else{
	$bea_materai = 0;
}	
/**gagat end materai 25 JAN 2020*/
...
if($valas == 'USD') {
  $query_sum="select to_char(dpp_usd,'9,999,999,999,999.00') DPP_,
      ...
      icttax_reference,
      ICT_REMARKS,
	  CUST_NO,CUST_NAME,CUST_ADDR,CUST_TAX_NO
...
if($valas == 'USD') {
    ...
    $ppn_070 = '0.00';
    $ppn_080 = '0.00';
    $ictremarks=$rwsum['ICT_REMARKS'];
    $ictremarksp="<p><i>Remarks: $ictremarks</i></p>";
    if($rwsum['ICTTAX_REFERENCE'] == '010') {
      $ppn_010 = $rwsum['PPN_'];
    }
    else if($rwsum['ICTTAX_REFERENCE'] == '030') {
      $ppn_030 = $rwsum['PPN_'];
    }
    else if($rwsum['ICTTAX_REFERENCE'] == '070') {
      $ppn_070 = $rwsum['PPN_'];
    }
    else if($rwsum['ICTTAX_REFERENCE'] == '080') {
      $ppn_080 = $rwsum['PPN_'];
    }
}
else{
...
BONGKAT / MUAT</b></font></td>
               ...
               <tr height="30">
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td colspan="9" align="left">$rwsum[CUST_NAME]</td>
                    <td colspan="3"></td>
                ...
                <tr>
                    ...
                    <td colspan="0">:</td>
                    <td colspan="9" align="left">$rwsum[CUST_TAX_NO]</td>
                    <td  colspan="3"></td>
                ...
                <tr>
                    ...
                    <td colspan="0">:</td>
                    <td colspan="9" align="left">$rwsum[CUST_ADDR]</td>
                    <td  colspan="3"></td>
               ...
               <tr height="30">
                ...
                <tr>
                  <td colspan="13"></td>
                  <td colspan="8"  align="left">Discount :</td>
                            <td colspan="7" align="right"></td>
                  <td colspan="2"></td>
                </tr>
                <tr>
                  <td colspan="13"></td>
                  <td colspan="8"  align="left">Administrasi :</td>
                            <td colspan="7" align="right">$rwsum[ADM_]</td>
                  <td colspan="2"></td>
                </tr>
                <tr>
                  <td colspan="13"></td>
                  <td colspan="8"  align="left">Dasar Pengenaan Pajak :</td>
                            <td colspan="7" align="right">$rwsum[DPP_]</td>
                  <td colspan="2"></td>
                </tr>
                <tr>
                  <td colspan="13"></td>
                  <td colspan="8"  align="left">a. PPN dipungut sendiri :</td>
                            <td colspan="7" align="right">$ppn_010</td>
                  <td colspan="2"></td>
                </tr>
                <tr>
                  <td colspan="13"></td>
                  <td colspan="8"  align="left">b. PPN dipungut Pemungut :</td>
                            <td colspan="7" align="right">$ppn_030</td>
                  <td colspan="2"></td>
                </tr>
                <tr>
                  <td colspan="13"></td>
                  <td colspan="8"  align="left">c. PPN tidak dipungut :</td>
                            <td colspan="7" align="right">$ppn_070</td>
                  <td colspan="2"></td>
                </tr>
                <tr>
                  <td colspan="13"></td>
                  <td colspan="8"  align="left">d. PPN dibebaskan :</td>
                            <td colspan="7" align="right">$ppn_080</td>
                  <td colspan="2"></td>
                </tr>
                <tr>
                  <td colspan="13"></td>
                    <td colspan="8"  align="left">Jumlah PPN Subsidi :</td>
				...
				<tr>
                  <td colspan="13"></td>
                  <td colspan="8"  align="left">Bea Materai :</td>
                ...
                <tr>
                  <td colspan="13"></td>
                  <td colspan="8"  align="left">Jumlah Dibayar :</td>
                ...
                <tr>
                  <td colspan="13"></td>
                  <td colspan="8"  align="left">$label_idr</td>
