...
$db=getdb('dbint');
//$no_ukk='2';
$query_h 	= "select VESSEL, OPERATOR_NAME, to_char(to_date(ATA,'YYYYMMDDHH24MISS'),'dd-MON-rr hh24:mi') ATA, to_char(to_date(ATD,'YYYYMMDDHH24MISS'),'dd-MON-rr hh24:mi') ATD, to_char(to_date(ETA,'YYYYMMDDHH24MISS'),'dd-mm-rrrr') ETA, VOYAGE_IN, VOYAGE_OUT, to_char(to_date(BERTHING_TIME,'YYYYMMDDHH24MISS'),'dd-MON-rr hh24:mi') BERTHING, to_char(to_date(START_WORK,'YYYYMMDDHH24MISS'),'dd-MON-rr hh24:mi') START_WORK, to_char(to_date(END_WORK,'YYYYMMDDHH24MISS'),'dd-MON-rr hh24:mi') END_WORK
                FROM m_vsb_voyage
...
,a.STATUS_CONT,HZ, count(1) BOX, LABEL, case when substr(a.ALAT,1,2)='QC' THEN 'CC' ELSE 'SC' END ALAT
...
group by a.E_I, b.SIZE_, b.TYPE_, b.H_ISO,a.STATUS_CONT,a.HZ,a.LABEL, case when substr(a.ALAT,1,2)='QC' THEN 'CC' ELSE 'SC' END"; 
...
$ttl=$tm+$tb;
	$tbl .= <<<EOD
					...
					<tr><td colspan="2"></td><td colspan="2" align="center">MANAGER AREA PONTIANAK</td></tr>
					<tr><td colspan="4"></td></tr>
					<tr><td colspan="4"></td></tr>
					<tr><td colspan="4"></td></tr>
					<tr><td colspan="2"></td><td colspan="2" align="center">MOCHAMMAD LOUTFIE HIDAYAT</td></tr>
					<tr><td colspan="2"></td><td colspan="2" align="center">NIPP :  277106604      </td></tr>
