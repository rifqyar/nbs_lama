...
{
	$('#pay').load("<?=HOME?>billing.paymentcash.ajax/payment?idn="+a+"&req="+b+"&ket="+c+"&vessel="+encodeURIComponent(vessel)+"&voyin="+encodeURIComponent(voyin)+"&voyout="+encodeURIComponent(voyout)+"&total="+total).dialog({modal:true, height:500,width:350, title : "Payment cash"});
}
...
<div class="content">
	<div class="main_side">
	<p>
	 <img src="<?=HOME?>images/crdc.png" style="vertical-align:middle">&nbsp;<b> <font color='#69b3e2' size='5px'>Transfer</font> </b>
