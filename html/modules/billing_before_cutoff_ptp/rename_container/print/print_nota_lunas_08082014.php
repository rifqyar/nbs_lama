...
$query="SELECT ID_NOTA, NO_RENAME FROM NOTA_RENAME_CONTAINER WHERE TRIM(NO_RENAME) = TRIM('$no_req')";
$hasil=$db->query($query);
$hasil_=$hasil->fetchRow();
$notanya=$hasil_['ID_NOTA'];

$query="UPDATE NOTA_RENAME_CONTAINER SET TGL_CETAK=SYSDATE WHERE NO_RENAME='$no_req'";
$db->query($query);


$query="SELECT a.NO_RENAME ID_REQ, 
			   ...
			   a.ID_USER,
			   a.VESSEL,a.VOYAGE 
        FROM NOTA_RENAME_CONTAINER a
		WHERE a.NO_RENAME = '$no_req'";
...
$query_dtl="SELECT TO_CHAR(a.TARIF, '999,999,999,999') AS TARIF, 
					  ...
					  b.STATUS
					  FROM NOTA_RENAME_CONTAINER_D a left join  master_barang b on (a.ID_CONT = b.KODE_BARANG)
					  where a.NO_RENAME = '$no_req' and KETERANGAN <> 'ADM'";
	...
	foreach($row2 as $rows) {
		...
		<tr><td colspan="3" width="150"><font size="8">'.$rows[KETERANGAN].'</font></td>
                        ...
                        <td colspan="7" width="180" align="right"><font size="8">'.$rows[TARIF].'</font></td>
                        <td colspan="7" width="40" align="center">IDR</td>
                        <td colspan="7" width="115" align="right"><font size="8">'.$rows[SUB_TOTAL].'</font></td>        
                        </tr>                        
...
$query_jum="SELECT COUNT(1) JUM_DETAIL FROM NOTA_RENAME_CONTAINER_D A WHERE A.NO_RENAME='$no_req' AND KETERANGAN <> 'ADM'";
...
for($pg=1; $pg<=$jum_page; $pg++) {
	...
	$tbl = <<<EOD
			<table border='0'>
                ...
                <tr>
                    <td COLSPAN="6"></td>
                    <td COLSPAN="8" align="right"><font size="11"><b>PRANOTA RENAME CONTAINER (BATAL DOKUMEN)</b></font></td>
                ...
                <tr>
                   ...
                   <th colspan="10" width="300" align="center"><font size="8"><b>TARIF</b></font></th>
                    <th colspan="10" width="40" align="center"><font size="8"><b>VAL</b></font></th>
                    <th colspan="10" width="115" align="center"><font size="8" ><b>JUMLAH</b></font></th>
                </tr>
                <tr>
                    <td colspoan="14">
