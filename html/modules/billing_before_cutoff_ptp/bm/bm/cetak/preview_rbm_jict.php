			...
			<table border="0">
					...
					<tr>
						<td colspan="4">
										...
										<tr>
											<td width="105" rowspan="2" colspan="3"><b>SIZE - TYPE - STATUS</b></td>
											<td width="90" colspan="2" ><font size="7pt"><b>TOTAL DISCHARGE</FONT></b></td> 
											<td width="90" colspan="2" ><b>TOTAL LOADING</b></td> 
											<td width="90" colspan="2" style="vertical-align:middle;"><font size="7pt"><b>TRANSHIPMENT</font></b></td> 
											<td width="90" colspan="2" ><b>TOTAL TRANS</b></td>
											<td width="100" colspan="2"><b>SHIFTING</b></td> 
											<td width="90" colspan="2" ><b>TOTAL SHIFTING</b></td>
											<td width="40"><b>HATCH</b></td>
										</tr>  
										<tr>
											<td width="45" ><b>BOX</b></td>
											<td width="45" ><b>TEUS</b></td>
											<td width="45" ><b>BOX</b></td>
											<td width="45" ><b>TEUS</b></td>
											<td width="45" ><b>DISCH</b></td>
											<td width="45" ><b>LOAD</b></td>
											<td width="45" ><b>BOX</b></td>
											<td width="45" ><b>TEUS</b></td>
											<td width="50" ><b>LANDED</b></td>
											<td width="50" ><b>UNLANDED</b></td>
											<td width="45" ><b>BOX</b></td>
											<td width="45" ><b>TEUS</b></td>
...
EOD;
$query_d 	= "select 
rd.SIZE_,rd.TYPE_,rd.STATUS,CASE WHEN rd.HEIGHT='OOG' THEN '/OOG' ELSE '' END HEIGHT,
nvl((select sum(r1.BOX) from rbm_d r1 where r1.SIZE_=rd.SIZE_ and r1.TYPE_=rd.TYPE_ and r1.STATUS=rd.STATUS and r1.EI='I'),0) AS BOX_D,
case when rd.SIZE_='20' then 
    nvl((select sum(r1.BOX) from rbm_d r1 where r1.SIZE_=rd.SIZE_ and r1.TYPE_=rd.TYPE_ and r1.STATUS=rd.STATUS and r1.EI='I'),0)
    else
    nvl((select sum(r1.BOX) from rbm_d r1 where r1.SIZE_=rd.SIZE_ and r1.TYPE_=rd.TYPE_ and r1.STATUS=rd.STATUS and r1.EI='I'),0)*2 end TEUS_D,
nvl((select sum(r1.BOX) from rbm_d r1 where r1.SIZE_=rd.SIZE_ and r1.TYPE_=rd.TYPE_ and r1.STATUS=rd.STATUS and r1.EI='E'),0) AS BOX_E,
case when rd.SIZE_='20' then 
    nvl((select sum(r1.BOX) from rbm_d r1 where r1.SIZE_=rd.SIZE_ and r1.TYPE_=rd.TYPE_ and r1.STATUS=rd.STATUS and r1.EI='E'),0)
    else
    nvl((select sum(r1.BOX) from rbm_d r1 where r1.SIZE_=rd.SIZE_ and r1.TYPE_=rd.TYPE_ and r1.STATUS=rd.STATUS and r1.EI='E'),0)*2 end TEUS_E

from rbm_d rd
where rd.NO_UKK='$no_ukk'
group by 
rd.SIZE_,rd.TYPE_,rd.STATUS,rd.HEIGHT
ORDER BY rd.SIZE_,rd.TYPE_,rd.STATUS";
