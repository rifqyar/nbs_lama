<?php
    ...
    $status_time = "wt";
	   ...
	   if($stat=="req")
	   {
		...
		{
			$query3 = "SELECT DISTINCT ID_ALAT FROM GLC_DETAIL_REQUEST_SHIFT WHERE ID_REQ = '$id_reqs' AND STAT_TIME = 'WAITING' AND EST_REAL = 'REALISASI'";
