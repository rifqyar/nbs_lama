...
else
{
	...
	if(strstr($_POST['PERDAGANGAN'],"O")) {
		...
		$sql = "INSERT INTO UPER_H (NO_UPER, NO_UKK, VALUTA, USER_ENTRY) VALUES ('".$no_uper1."','".$no_ukk."','USD','".$user."')";
		$db->query($sql);
	...
	if(strstr($_POST['PERDAGANGAN'],"I")) {
		...
		$sql = "INSERT INTO UPER_H (NO_UPER, NO_UKK, VALUTA, USER_ENTRY) VALUES ('".$no_uper2."','".$no_ukk."','IDR','".$user."')";
		$db->query($sql);
