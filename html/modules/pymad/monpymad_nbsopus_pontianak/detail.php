...
jQuery(function() {
 jQuery("#l_user").jqGrid({
	url:'pymad.monpymad_nbsopus_pontianak.data/?notaname=<?php echo $NOTANAME;?>&status=<?php echo $STATUS;?>&year=<?php echo $YEAR;?>',
	mtype : "post",
	datatype: "json",
	...
	del:false
	 ...
	 jQuery('#print').click(function(){
		 window.open("<?=HOME?>pymad.monpymad_nbsopus_pontianak.data/?notaname=<?php echo $NOTANAME;?>&status=<?php echo $STATUS;?>&year=<?php echo $YEAR;?>&print=ok",'_blank');
	 });
	});
</script>
