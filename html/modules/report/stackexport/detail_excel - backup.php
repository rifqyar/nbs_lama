...
SELECT
        ...
        CASE 
            ...
            WHEN (DURASI > 10) AND (AKHIR_MASA2 > ETD) THEN (AKHIR_MASA2 - ETD)
            WHEN DURASI > 10 THEN 0
            WHEN (DURASI > 5) AND (AKHIR_MASA1 > ETD) THEN ((ATD - ETD) - (AKHIR_MASA1 - ETD))
            WHEN (DURASI > 5 ) THEN ATD - ETD
            END
        ...
        CASE 
            WHEN DURASI = 10 THEN 0
            WHEN DURASI < 10 THEN 0          
            WHEN DURASI > 10   AND (AKHIR_MASA2 <= ETD) THEN ATD - ETD  
            WHEN (DURASI > 10)  AND (AKHIR_MASA2 > ETD) then ((ATD - ETD) - (AKHIR_MASA2 - ETD)) 
        END                   
