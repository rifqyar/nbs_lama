<?
     ...
     $query_yard            = "SELECT ID,NAMA_YARD FROM YD_YARD_AREA WHERE STATUS = 'AKTIF'";
     $result_yard           = $db->query($query_yard);
     $yard_name             = $result_yard->fetchRow();
     $name                  = $yard_name['NAMA_YARD'];
	 
	 $yard_id 				= $yard_name['ID'];
...
<div id="load_layout" >
	...
	<div align="center" width="10%"><br>
      <h4>Layout Allocations <?=$name?><br>
	Tanggal <?=$_GET['tgl'];?> Pukul <?=$_GET['per'];?></h4>
	</div>
                ...
                // echo " SELECT COUNT(ID_PLACEMENT) JUM FROM YD_PLACEMENT_YARD WHERE ID_BLOCKING_AREA = '$id_block' AND SLOT_YARD = '$slot_' AND ROW_YARD = '$row_' AND ID_CELL = '$index_cell_' ";
                  ...
                  <?	}else if (($size_ == '40') && ($type_ == 'DRY') &&($status_ =='FCL')){ ?>
					...
					<?     } else if (($size_ == '40') && ($status_ =='MTY')){ ?>
                           <td onMouseOver="this.style.backgroundColor='#CCFF33'" onMouseOut="this.style.backgroundColor='#86BCFF'" align="center" style="width:30px;height:15px;font-size:8px; font-family:Tahoma; background-image:url('<?=HOME?>yard/src/css/excite-bike/images/empty.png'); background-size:10px 5px" <?=$cr?>><font color="#ffffff"><?=$status_?></font></td>
						   
					<?     } else if (($size_ == '20') && ($status_ =='MTY')){ ?>
                           <td onMouseOver="this.style.backgroundColor='#CCFF33'" onMouseOut="this.style.backgroundColor='#86BCFF'" align="center" style="width:30px;height:15px;font-size:8px; font-family:Tahoma; background-image:url('<?=HOME?>yard/src/css/excite-bike/images/empty.png'); background-size:10px 5px" ><font color="#ffffff"><?=$status_?></font></td>
					
                   <?     } else if (($size_ == '40') && ($type_ == 'HQ')){ ?>
                           <td onMouseOver="this.style.backgroundColor='#CCFF33'" onMouseOut="this.style.backgroundColor='#86BCFF'" align="center" style="width:30px;height:15px;font-size:8px; font-family:Tahoma; background-image:url('<?=HOME?>yard/src/css/excite-bike/images/ungu.png'); background-size:10px 5px" <?=$cr?>><font color="#ffffff"><?=$kategori2?></font></td>
                   ...
                   <?    } else if (($size_ == '20') && ($type_ == 'DG')){ ?>
					...
					<?    } else if (($size_ == '40') && ($type_ == 'RFR')){ ?>
                           <td onMouseOver="this.style.backgroundColor='#CCFF33'" onMouseOut="this.style.backgroundColor='#86BCFF'" align="center" style="width:30px;height:15px;font-size:8px; font-family:Tahoma;background-image:url('<?=HOME?>yard/src/css/excite-bike/images/20flt.png');background-size:10px 5px"  <?=$cr?>><?=$kategori2?></td>
					...
					<?    } else if (($size_ == '40') && ($type_ == 'TNK')){ ?>
                           <td onMouseOver="this.style.backgroundColor='#CCFF33'" onMouseOut="this.style.backgroundColor='#86BCFF'" align="center" style="width:30px;height:15px;font-size:8px; font-family:Tahoma;background-image:url('<?=HOME?>yard/src/css/excite-bike/images/40rfr.png');background-size:10px 5px"  <?=$cr?>><?=$kategori2?></td>
					...
					<?    } else if (($size_ == '40') && ($type_ == 'OT')){ ?>
                           <td onMouseOver="this.style.backgroundColor='#CCFF33'" onMouseOut="this.style.backgroundColor='#86BCFF'" align="center" style="width:30px;height:15px;font-size:8px; font-family:Tahoma;background-image:url('<?=HOME?>yard/src/css/excite-bike/images/abu2.png');background-size:10px 5px"  <?=$cr?>><?=$kategori2?></td>
                   <?    } else if ($kategori2 == '1'){ ?>
				   ...
				   <?    } else if ($kategori2 == '3'){ ?>
					 ...
					 <?    } else if ($kategori2 == '4'){ ?>
                           ...
                           <td onMouseOver="this.style.backgroundColor='#CCFF33'" onMouseOut="this.style.backgroundColor='#86BCFF'" align="center" style="width:30px;height:15px;font-size:8px; font-family:Tahoma;background-image:url('<?=HOME?>yard/src/css/excite-bike/images/ui-bg_diagonals-thick_18_b81900_40x40green.png');background-size:10px 5px"  <?=$cr?>>kat <?=$kategori2?></td>
						   	 <?    } else if ($kategori2 == '6'){ ?>
                           <td onMouseOver="this.style.backgroundColor='#CCFF33'" onMouseOut="this.style.backgroundColor='#86BCFF'" align="center" style="width:30px;height:15px;font-size:8px; font-family:Tahoma;background-image:url('<?=HOME?>yard/src/css/excite-bike/images/ungu.png');background-size:10px 5px"  <?=$cr?>>kat <?=$kategori2?></td>
				   	 <?    } else if ($kategori2 == '7'){ ?>
                           <td onMouseOver="this.style.backgroundColor='#CCFF33'" onMouseOut="this.style.backgroundColor='#86BCFF'" align="center" style="width:30px;height:15px;font-size:8px; font-family:Tahoma;background-image:url('<?=HOME?>yard/src/css/excite-bike/images/OVD.png');background-size:10px 5px"  <?=$cr?>>kat <?=$kategori2?></td>
					<?    } else if ($kategori2 == '8'){ ?>
