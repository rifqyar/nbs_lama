...
if (_map($filter)) {
    ...
    if (isset($_SESSION['__postback'][APPID])) {
        ...
        $db  = getDB();
        $sql = "SELECT A.ID_NOTA, A.TGL_INVOICE, A.ID_BPRP, TO_CHAR(A.TOTAL, '999,999,999,999') TOTALNYA, A.NO_JKM, TO_CHAR(A.TGL_JKM,'DD-MM-YYYY') TGL_JKM
				FROM OG_NOTA_LOLOH A
