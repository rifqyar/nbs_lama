...
function export_excel()
{
	var v_periode_awal = $("#periode_awal").val();
        ...
        window.open("<?=$HOME?>report.pendapatan.receiving/detail_excel?awal=" + v_periode_awal + "&akhir=" + v_periode_akhir);        
    ...
    function tampilkan_pendapatan() {
        var v_periode_awal = $("#periode_awal").val();
        var v_periode_akhir = $("#periode_akhir").val();
        $('#detail_pendapatan').load("<?= HOME ?>report.pendapatan.receiving/detail?awal=" + v_periode_awal + "&akhir=" + v_periode_akhir);
    }

</script>

<h1>Laporan Pendapatan Receiving</h1>
