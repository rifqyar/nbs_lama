...
<?php
	...
	$query_blok = "select count(1) JUMLAH from (select * from ret_blocking_cell where date_created > TO_DATE('$tgl $per','dd/mm/rrrr hh24:mi:ss') AND date_created < TO_DATE('$tgl $per','dd/mm/rrrr hh24:mi:ss')+4/24)  a, yd_blocking_area b 
	...
	$query_blok2 = "select count(1) JUMLAH_ISI from (select * from ret_blocking_cell where date_created > TO_DATE('$tgl $per','dd/mm/rrrr hh24:mi:ss') AND date_created < TO_DATE('$tgl $per','dd/mm/rrrr hh24:mi:ss')+4/24) a, yd_blocking_area b 
					where b.ID_YARD_AREA=81 and a.ID_BLOCKING_AREA=B.ID";
...
<br>
<h2>YOR Performance <br>
Tanggal <?=$tgl?> Pukul <?=$per?></h2>
<div align='center'>
