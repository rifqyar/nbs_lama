...
<h2><image src="<?=HOME?>images/filter.png" width="50" height="50"> &nbsp Filter Lapangan  </br> Tanggal <?=$tgl?> Pukul  <?=$per?></h2>
<div align='center'>
...
<form id="form" method="POST" action="<?=HOME?>report.yard_periodik.yard/load_layout_placement">
				<table border="0">
					<tr height="20">
					...
					<tr>
						<td colspan="5" align="right"><input type="submit" value=" Proses " /> 
						<input type="hidden" name="tgl" id="tgl" value='<?=$tgl?>' size="20"> 
						<input type="hidden" name="per" id="per" value='<?=$per?>' size="20"> </a>
						</td>
					</tr>
				</table>
				</form>
