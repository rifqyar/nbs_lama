...
$query_dtl="SELECT A.*,C.*, to_char(A.TARIF,'999,999,999,999,999.00') AS TARIFN, to_char(A.SUB_TOTAL,'999,999,999,999,999.00') AS SUB_TOTALN 
	...
	foreach($row2 as $rows) {
		...
		<tr><td colspan="3" width="100"><font size="6">'.$rows[KETERANGAN].'</font></td>                                                    
                        ...
                        <td width="43" align="right"><font size="6">'.$rows[TARIF].'</font></td>                        
                        <td width="43" align="right"><font size="6">'.$rows[SUB_TOTAL].'</font></td>        
                        </tr>   
                        <tr>
		<td colspan="8"><font size="6"><i>('.$rows[TGL_START_STACK].' s/d '.$rows[TGL_END_STACK].')</i><b> '.$rows[JUMLAH_HARI].' hari</b></font></td></td>
                         </tr>
		';
                        }else
                            $detail .= '
...
for($pg=1; $pg<=$jum_page; $pg++) {
	...
	$tbl = <<<EOD
			<table>
                ...
                <tr>                    
                    <td COLSPAN="4" align="left"><font size="6">$data[CUSTOMER]</font></td>					
                </tr>
                <tr>                    
                    <td COLSPAN="4" align="left"><font size="6">$data[NPWP]</font></td>                    
                </tr>
                <tr>                    
                    <td COLSPAN="6" align="left"><font size="6">$data[ALAMAT]</font></td>					
                </tr>
                <tr>                    
                    <td COLSPAN="4" align="left"><font size="6">$data[VESSEL] / $data[VOYAGE] - $data[VESSEL_DT]/$data[VOYAGE_DT]</font></td>                    
                </tr>                                              
                
                
                <tr>
                    <td width="80" align="left"><font size="6">MASA PENUMPUKAN:</font> </td>                    
                    <td colspan="5"><font size="6">$detail2</font></td>                    
                </tr>                                    
...
<table>                    
                    ...
                    <tr>
                        ...
                        <td colspan="5" align="right">Dasar Peng. Pajak :</td>
                    ...
                    <tr>
                        ...
                        <td colspan="5" align="right">Jumlah PPN Subsidi :</td>
