<?php
	...
	$query_nota	= "SELECT b.EMKL, b.ALAMAT, b.NPWP, b.TGL_REQUEST, b.VESSEL, b.VOYAGE_OUT AS VOYAGE, TGL_SPPB, TGL_SP2, DISCH_DATE, TIPE_REQ FROM req_delivery_h b
	...
	//Biaya Administrasi
	$jml_cont	= "SELECT COUNT(NO_CONTAINER) JML FROM req_delivery_d WHERE NO_REQ_DEV = '$no_req'";
        //echo $total_;die;
