...
$query_k 	= "SELECT NVL(MAX(COUNTER),0) COUNT FROM LOG_RBM where NO_UKK='$no_ukk' AND KETERANGAN = 'PRANOTA'";
...
$date = date('dMYh:i:s');
ob_clean();
$pdf->Output('./report/pdf_pranota/PRANOTA_'.$ves_id.'_'.$voy_in.$voy_out.'_'.$counter.'.pdf', 'F');
