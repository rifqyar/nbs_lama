<?php
	...
	//--------------------------
	$query_nota	= "SELECT b.PBM EMKL, b.ALAMAT, b.NPWP, b.TGL_RENAME, b.VESSEL, b.VOYAGE, b.TGL_RENAME TGL_REQUEST  FROM RENAME_CONTAINER b
					WHERE b.NO_RENAME = '$no_req'
				   ";
	//echo $query_nota;die;			   
	...
	$detail_nota  = " SELECT TO_CHAR(a.TARIF, '999,999,999,999') AS TARIF, 
					  ...
					  FROM RENAME_CONTAINER_TEMP A left join master_barang b on (a.ID_CONT = b.kode_barang)
	...
	$total_		  = "SELECT SUM(SUB_TOTAL) TOTAL FROM RENAME_CONTAINER_TEMP WHERE NO_RENAME = '$no_req'";
	//echo $total_ ;die;
