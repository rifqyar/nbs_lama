...
<div class="content">
	<table>
		...
		<tr>
			...
			<td>: <input type="text" size='40' value="<?=$res[CUST_NAME];?>" id='custnm'/> <input type="text" size='5' value="<?=$res[CUST_NO];?>" id='custno'/> <button onclick='sub_cust()' title='Update Customer'><img src="images/hhdd.png" width="20"></button></td>
		</tr>
		<tr>
