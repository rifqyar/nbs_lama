...
$id = $_GET['id'];
$db = getDB();
$query="SELECT DISTINCT VOYAGE, VESSEL, EMKL, SHIPPING_LINE, TGL_BERANGKAT2, ALAMAT, NPWP, JENIS, A.STATUS, KODE_PBM, B.TGL_STACK, B.NO_UKK, KET, A.CUSTOM_NUMBER FROM TB_BATALMUAT_H A LEFT JOIN TB_BATALMUAT_D B ON A.ID_BATALMUAT=B.ID_BATALMUAT WHERE A.ID_BATALMUAT='".$id."'";
// echo $query;die;
