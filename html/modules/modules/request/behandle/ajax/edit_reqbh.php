...
else
{
	if($tipe=='Import')
	{
		...
		$ei='E';
	$db=getDB();
	$sql = "UPDATE BH_REQUEST SET NOMOR_INSTRUKSI='".$no_bc."', VOYAGE='".$voyage."', VESSEL='".$vessel."', 
			EMKL='".$emkl."', COA='".$coa."', ALAMAT_EMKL='".$alamat."', NPWP='".$npwp."', 
			TIPE_REQ='".$tipe."', SHIPPING_LINE='".$shipping."', 
			KET='".$ket."', NO_UKK='".$no_ukk."', PAID_THRU=to_date('".$paid_thru."','DD-MM-YYYY') 
	...
	$sql = "DELETE BH_DETAIL_REQUEST WHERE ID_REQUEST='".$no_req."'";
	$db->query($sql);
