...
else
{
	...
	$sql = "INSERT INTO BH_REQUEST (ID_REQUEST, TGL_REQUEST, NOMOR_INSTRUKSI, ID_USER, VOYAGE, VESSEL, EMKL, COA, ALAMAT_EMKL, NPWP, TIPE_REQ, SHIPPING_LINE, KET, NO_UKK, VOYAGE_OUT, PAID_THRU, TYPE_SPJM,TGL_SPJM) 
	VALUES ('".$no_req."',SYSDATE,'".$no_bc."','".$_SESSION["ID_USER"]."','".$voyage."','".$vessel."','".$emkl."','".$coa."','".$alamat."','".$npwp."','".$tipe."','".$shipping."','".$ket."','".$no_ukk."','".$voyage_out."',null, '".$type_spjm."', to_date('".$tgl_spjm."','dd-mm-yyyy'))";
	//print_r($sql);die;
	$db->query($sql);
