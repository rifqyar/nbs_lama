...
$id = $_GET['id'];
$db = getDB();
$query="SELECT NOMOR_INSTRUKSI, to_char(PAID_THRU, 'DD-MM-YYYY') AS PAID_THRU,ID_USER, VOYAGE, VESSEL, EMKL, ALAMAT_EMKL, NPWP, TIPE_REQ, STATUS, SHIPPING_LINE, KET, NO_UKK, COA, VOYAGE_OUT FROM BH_REQUEST WHERE ID_REQUEST='".$id."'";
// echo $query;die;
...
// }
	...
	<table>
		...
		<tr>
			...
			<td class="form-field-caption" align="right"> : </td>
			<td class="form-field-caption" align="left">
				<input type="text" name="tgl_spjm" id="tgl_spjm" size="30" />
			</td>
		</tr>
...
<?php
$sql2 = "SELECT * FROM BH_DETAIL_REQUEST WHERE ID_REQUEST='".$id."' ORDER BY ID";
$rs2 = $db->query( $sql2 );
// echo $sql2;
$j=0;
