...
jQuery(function() {
 jQuery("#l_vessel").jqGrid({
	url:"<?=HOME?>datanya/data_cont?q=rec&r=<?=$req;?>",
	mtype : "post",
	datatype: "json",
	colNames:['','NO CONTAINER','','HZ','ISO_CODE','HEIGHT','CARRIER','OG','Commodity'], 
	colModel:[
		...
		{name:'izo',index:'izo', width:80, align:"center"},
		{name:'hg',index:'hg', width:80, align:"center"},
		{name:'cr',index:'cr', width:80, align:"center"},
		{name:'og',index:'og', width:50, align:"center"},
