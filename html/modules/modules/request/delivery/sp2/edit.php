...
function add_cont1(i,j)
{
	...
	{
$.post(url,{VIN :vin,VESX :vesx, NC: nc,SC:sc, TC:tc, STC:stc, HC:hc, COMM:comm, IMO:imo, ISO:iso, REQ:i, HGC:hgc, SHIP:j, CAR:car, TEMP:tmp,UKK:ukk, BOOKSL: booksl, OW:ow, OH:oh, OL:ol, UNNUMBER:unnumber, POD:pod, POL:pol, PLI:pli, PLO:plo},function(data){	
