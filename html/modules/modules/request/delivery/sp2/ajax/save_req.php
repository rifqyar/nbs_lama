<?php
	...
	$query = "declare begin proc_create_delivery(:v_jenis_sppb, :v_callsign,:v_idvesscd,:v_ves,:v_vin,:v_vout,:v_ddsc,:v_iemkl,:v_sppb,:v_tglsppb,:v_ndo,:v_tgldo,:v_tgldel,:v_ship,:v_via,:v_ket,:v_user,:v_spcust,:v_tgl_spcust,:v_blnumb,:v_cargow,:v_icargow,:v_no_req,:v_msg); end;";		
