...
function autocompletenya(index) {
	...
	$( "#no_cont"+index ).autocomplete({
		minLength: 4,
		source: "request.delivery.sp2spjm_opus.auto/container_manual?no_ukk="+v_noukk+"",
		focus: function( event, ui ) 
		{
...
{
	//alert('coba');
	var url = "<?=HOME?>request.delivery.sp2spjm_opus.ajax/add_spjm_manual";
	...
	<table>
		...
		<tr>
			...
			<td class="form-field-caption" align="left">
				<input type="text" name="plp_no" id="plp_no" size="15" />&nbsp;)*Number Only
			</td>			
		</tr>
		<tr>
