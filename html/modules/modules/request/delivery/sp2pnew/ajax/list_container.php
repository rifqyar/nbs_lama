...
jQuery(function() {
 jQuery("#l_vessel").jqGrid({
	...
	colModel:[
		...
		{name:'pli',index:'pli', width:100, align:"center", editable:false},
		{name:'plo2',index:'plo', width:100, align:"center", editable:true, readonly:true},
		{name:'plo',index:'plo', width:100, align:"center", hidden: true, editable:true, readonly:true, editrules: { edithidden: false }},
