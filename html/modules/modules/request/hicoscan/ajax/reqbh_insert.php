...
$(document).ready(function(){
	...
	$("#vessel").autocomplete({
		...
		select: function( event, ui ) 
		{
			...
			glob_vessel = ui.item.VESSEL_CODE;
			return false;
		}
	})
...
{
	if($("#tipe_req").val()=="") {
		alert("pilih jenis request terlebih dahulu!!!");
	}
...
// }
	...
	<table>
		...
		<tr>
			...
			<td class="form-field-caption" align="right"> : </td>
			<td class="form-field-caption" align="left">
				<input type="text" name="vessel" id="vessel" size="30" placeholder="Autocomplete"/> / <input type="text" name="voyage" id="voyage" size="5" ReadOnly /><input type="text" name="voyage_out" id="voyage_out" size="5" ReadOnly /><input type="hidden" name="vessel_code" id="vessel_code" />
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="form-field-caption" align="right"> : </td>
			<td class="form-field-caption" align="left">
				<input type="text" name="paid_thru" id="paid_thru" size="30" ReadOnly />
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="form-field-caption" align="left">
				...
				<button onclick="sync_pelanggan()" title="sync data pelanggan"><img src="<?=HOME;?>images/sync.png" width="15" height="15"/></button>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="3" align="center">
				...
				<input type="button" name="Insert Request Hicoscan" value="&nbsp;Insert&nbsp;" onclick="validation('tableedit')"/>
			</td>
		</tr>
	</table>		