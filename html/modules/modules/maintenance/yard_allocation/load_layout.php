                ...
                // echo " SELECT COUNT(ID_PLACEMENT) JUM FROM YD_PLACEMENT_YARD WHERE ID_BLOCKING_AREA = '$id_block' AND SLOT_YARD = '$slot_' AND ROW_YARD = '$row_' AND ID_CELL = '$index_cell_' ";
                  ...
                  <?	}else if (($size_ == '40') && ($type_ == 'DRY') &&($status_ =='FCL')){ ?>
					...
					<?     } else if (($size_ == '40') && ($status_ =='MTY')){ ?>
                           <td onMouseOver="this.style.backgroundColor='#CCFF33'" onMouseOut="this.style.backgroundColor='#86BCFF'" align="center" style="width:60px;height:15px;font-size:8px; font-family:Tahoma; background-image:url('yard/src/css/excite-bike/images/empty.png'); background-size:10px 5px" <?=$cr?>><font color="#ffffff"><?=$status_?></font></td>
						   
					<?     } else if (($size_ == '20') && ($status_ =='MTY')){ ?>
                           <td onMouseOver="this.style.backgroundColor='#CCFF33'" onMouseOut="this.style.backgroundColor='#86BCFF'" align="center" style="width:60px;height:15px;font-size:8px; font-family:Tahoma; background-image:url('yard/src/css/excite-bike/images/empty.png'); background-size:10px 5px" ><font color="#ffffff"><?=$status_?></font></td>
                   ...
                   <?    } else if (($size_ == '20') && ($type_ == 'DG')){ ?>
					...
					<?    } else if (($size_ == '40') && ($type_ == 'RFR')){ ?>
                           <td onMouseOver="this.style.backgroundColor='#CCFF33'" onMouseOut="this.style.backgroundColor='#86BCFF'" align="center" style="width:60px;height:15px;font-size:8px; font-family:Tahoma;background-image:url('yard/src/css/excite-bike/images/20flt.png');background-size:10px 5px"  <?=$cr?>><?=$kategori2?></td>
					...
					<?    } else if (($size_ == '40') && ($type_ == 'TNK')){ ?>
                           <td onMouseOver="this.style.backgroundColor='#CCFF33'" onMouseOut="this.style.backgroundColor='#86BCFF'" align="center" style="width:60px;height:15px;font-size:8px; font-family:Tahoma;background-image:url('yard/src/css/excite-bike/images/40rfr.png');background-size:10px 5px"  <?=$cr?>><?=$kategori2?></td>
					...
					<?    } else if (($size_ == '40') && ($type_ == 'OT')){ ?>
                           <td onMouseOver="this.style.backgroundColor='#CCFF33'" onMouseOut="this.style.backgroundColor='#86BCFF'" align="center" style="width:60px;height:15px;font-size:8px; font-family:Tahoma;background-image:url('yard/src/css/excite-bike/images/abu2.png');background-size:10px 5px"  <?=$cr?>><?=$kategori2?></td>
