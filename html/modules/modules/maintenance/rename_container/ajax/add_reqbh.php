...
else
{
	...
	$sql="declare begin proc_add_rena(:v_kd_barang,:v_booking_sl, :v_tipe,:v_no_ex_ct,:v_size,:v_type,:v_status,:v_vessel,:v_voyagein,:v_voyageout,:v_ukk,:v_custname,:v_custid,:v_custadd,:v_npwp,:v_remarks,:v_biaya,:v_nc,:v_ipaddr,:v_user,:v_custno,:v_pod,:v_fpod,:v_msg,:v_response);end;";
	$db->query($sql,$param);
