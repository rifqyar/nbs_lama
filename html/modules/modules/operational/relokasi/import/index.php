...
<script type="text/javascript">
	...
	{		
        $( "#NO_CONTAINER" ).autocomplete({
			minLength: 3,
			source: "operational.relokasi.import.auto/parameter",
		...
		$('#load_table_cont').load("<?=HOME?>operational.relokasi.import.table/find_cont?no_cont="+my_cont);
	});
	...
	function relocate(no_cont,sz,id_block,b,s,r,t)
	{
		...
		{
			myWindow=window.open('<?=HOME?>operational.relokasi.import.plc/relocate_cont?no_container='+no_cont+'&size_cont='+sz+'&id_block='+id_block+'&block='+b+'&slot='+s+'&row='+r+'&tier='+t,'','width=1200,height=700,scrollbars=yes,resizable=no');
			myWindow.focus();
		}		
	}
...
<html lang="en">
	...
	<span class="graybrown"><img src='images/cont_placement.png' align="absmiddle" width="80" border='0' class="icon"/>
		<font color="#DE7E21"> Form Re-location After Placement</font><font color="#0066CC"> [ IMPORT ]</font></span>
	<br>
	<br>
