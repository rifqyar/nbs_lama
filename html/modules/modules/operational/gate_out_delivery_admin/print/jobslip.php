<?
	...
	$db=getDb();
	$rq=$db->query("SELECT NO_UKK, VESSEL, VOYAGE_IN, VOYAGE_OUT FROM TR_NOTA_ANNE_ICT_H WHERE TRIM(NO_REQ_ANNE)=TRIM('$no_req')");
	$req=$rq->fetchRow();
	$ukk=$req['NO_UKK'];
...
<tr>
<tD colspan=5><font size=3px><?=$req['VESSEL'];?> <?=$req['VOYAGE_IN'];?>-<?=$req['VOYAGE_OUT'];?></font></td>
</tr>
<tr>
