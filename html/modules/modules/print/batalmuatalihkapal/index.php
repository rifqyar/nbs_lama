...
jQuery(function() {
 jQuery("#print_stacking_card").jqGrid({
	url:'<?=HOME?>datanya/data?q=print_batmuak',
	mtype : "post",
	datatype: "json",
	colNames:['','No Nota','No Req','QTY','EMKL','Vessel'], 
	colModel:[
		{name:'aksi', width:60, valign:"center", align:"center",sortable:false,search:false},
		{name:'no_nota',index:'nota', width:120, align:"center"},
		{name:'id_batalmuat',index:'id_req', width:120, align:"center"},
...
<div class="content">
	...
	<h2><span class="graybrown">
        ...
        &nbsp;<font color="#0378C6">Cetak</font> Kartu Batal Muat Alih Kapal
        </span></h2>	
	<p><br/></p>
