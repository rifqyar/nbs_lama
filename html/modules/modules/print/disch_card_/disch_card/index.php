...
function sync_yard(i)
{
	...
	var r		= confirm("Yard Allocation will be countered, Are You Sure?");
	...
	if (r==true)
	  {
		...
		if (s==true)
		{
				...
				//$.unblockUI({onUnblock: function(){  }});
				$("#v_baplie_import").jqGrid('setGridParam',{url:"<?=HOME?>data_dso?q=v_disch_card&template=false", datatype:"json"}).trigger("reloadGrid");
		}
	  }
	else
	  {
