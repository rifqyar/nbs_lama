	...
	function cek_nota($no_req)
	{
		...
		if(count($row_cek) > 0)
		{
			...
			if($ok == 'YES'){
				...
				{
					echo '<a href="'.HOME.APPID.'/print_nota_simple?no_req='.$no_req.'&n=999&koreksi=N" target="_blank"> <b><i> Preview Nota Stuffing</i></b></a> <br/>';
					echo '<a href="'.HOME.APPID.'/print_nota_pnkn?no_req='.$no_req.'&n=999&koreksi=N" target="_blank"> <b><i> Preview Nota Penumpukan</i></b></a> ';
				...
				{
					echo '<a href="'.HOME.APPID.'.print/print_nota_lunas_simple?no_req='.$no_req.'" target="_blank"><b><i> Cetak Ulang Nota Stuffing </i></b></a> <br>';
					echo '<a href="'.HOME.APPID.'./print_nota_pnkn?no_req='.$no_req.'&n=999&koreksi=N" target="_blank"> <b><i> Preview Nota Penumpukan</i></b></a> ';
				}
				else if(($row_cek["NOTA"] <> 'Y') AND ($row_cek["KOREKSI"] <> 'Y') AND ($row_cek["NOTA_PNKN"] == 'Y') AND ($row_cek["KOREKSI_PNKN"] <> 'Y'))
				{
					echo '<a href="'.HOME.APPID.'/print_nota_simple?no_req='.$no_req.'&n=999&koreksi=N" target="_blank"> <b><i> Preview Nota Stuffing</i></b></a> <br/>';
					echo '<a href="'.HOME.APPID.'.print/print_nota_lunas_pnkn?no_req='.$no_req.'" target="_blank"><b><i> Cetak Ulang Nota Penumpukan </i></b></a> '; 
				}
				else if(($row_cek["NOTA"] == 'Y') AND ($row_cek["KOREKSI"] <> 'Y') AND ($row_cek["NOTA_PNKN"] == 'Y') AND ($row_cek["KOREKSI_PNKN"] <> 'Y')  )
				{
					echo '<a href="'.HOME.APPID.'.print/print_nota_lunas_simple?no_req='.$no_req.'" target="_blank"><b><i> Cetak Ulang Nota Stuffing </i></b></a> <br/>';
				...
				{
					echo '<a href="'.HOME.APPID.'/print_nota_simple?no_req='.$no_req.'&n=999&koreksi=Y" target="_blank"> <b><i> Preview Nota Stuffing</i></b></a> <br/>';
					echo '<a href="'.HOME.APPID.'/print_nota_pnkn?no_req='.$no_req.'&n=999&koreksi=Y" target="_blank"> <b><i> Preview Nota Penumpukan</i></b></a>';
				}
				else if(($row_cek["NOTA"] <> 'Y') AND ($row_cek["KOREKSI"] == 'Y') AND ($row_cek["NOTA_PNKN"] <> 'Y') AND ($row_cek["KOREKSI_PNKN"] <> 'Y')  )
				{
					echo '<a href="'.HOME.APPID.'/print_nota_simple?no_req='.$no_req.'&n=999&koreksi=Y" target="_blank"> <b><i> Preview Nota Stuffing</i></b></a> <br/>';
				...
				{
					echo '<a href="'.HOME.APPID.'/print_nota_simple?no_req='.$no_req.'&n=999&koreksi=N" target="_blank"> <b><i> Preview Nota</i></b></a> ';
					//echo '<a href="'.HOME.APPID.'/cetak_nota?no_nota='.$no_nota.'&n='.$cetak.'" target="_blank"> CETAK ULANG </a> ';		
				}
				...
				{
					echo '<a href="'.HOME.APPID.'/print_nota_simple?no_req='.$no_req.'&n=999&koreksi=Y" target="_blank"> <b><i> Preview Nota </i></b></a> ';
				}
			}
