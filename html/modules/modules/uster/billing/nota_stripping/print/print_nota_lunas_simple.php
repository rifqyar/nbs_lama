 ...
 */
 ...
 $db 	 = getDB("storage");
	   ...
	   TO_CHAR(a.PASS,'999,999,999,999') PASS, a.EMKL NAMA, a.ALAMAT, a.NPWP, c.PERP_DARI, a.LUNAS,a.NO_FAKTUR, 
	   ...
	   CONCAT(TERBILANG(a.TOTAL_TAGIHAN),'rupiah') TERBILANG, c.NO_DO, c.NO_BL, m.NAMA_LENGKAP, CASE WHEN TRUNC(TGL_NOTA) < TO_DATE('1/6/2013','DD/MM/RRRR')
		THEN a.NO_NOTA
		ELSE A.NO_FAKTUR END NO_FAKTUR_
                            FROM nota_stripping a, request_stripping c, master_user m where
...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		$this->SetFont('Courier', 'B', 14);
		$this->SetY(36);
		$this->Cell(0, 15, 'NOTA STRIPPING', 0, false, 'R', 0, '', 0, false, 'T', 'M');
