...
$query_cek		= "SELECT b.NO_CONTAINER, b.LOCATION, NVL((SELECT NO_CONTAINER FROM CONTAINER_DELIVERY WHERE NO_CONTAINER = '$no_cont' AND AKTIF = 'Y'), '') as STATUS 
...
//utang are_id,are_id2,temp,class			
	...
	$query_cek		= "SELECT a.ID_YARD_AREA FROM placement b, blocking_area a 
        ...
        $query_insert   = "INSERT INTO CONTAINER_DELIVERY(NO_CONTAINER, NO_REQUEST, STATUS, AKTIF, 
														  KELUAR,HZ, KOMODITI,KETERANGAN,
														  NO_SEAL,BERAT,VIA,ID_YARD, 
														  NOREQ_PERALIHAN, START_STACK, ASAL_CONT) 
												   VALUES('$no_cont', '$no_req', '$status','Y',
														  'N','$hz','$komoditi','$keterangan',
														  '$no_seal','$berat','$via','$id_yard',
														  '$no_request', '$start_stack', '$asal_cont')";
