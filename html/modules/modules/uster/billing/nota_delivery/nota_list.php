<?php
	...
	function cek_nota($no_req)
	{
		...
		if(count($row_cek) > 0)
		{
			...
			{
				echo '<a href="'.HOME.APPID.'/print_nota_simple?no_req='.$no_req.'&koreksi=N" target="_blank"><b> Preview Nota</b> </a> ';
			...
			{
				echo '<a href="'.HOME.APPID.'.print/print_nota_lunas_simple?no_req='.$no_req.'" target="_blank" > Cetak Ulang </a> ';
			}
			else if(($row_cek[0]["NOTA"] == 'Y') AND ($row_cek[0]["KOREKSI"] == 'Y'))
			{
				echo '<a href="'.HOME.APPID.'.print/print_nota_lunas_simple?no_req='.$no_req.'" target="_blank" > Cetak Ulang </a> ';	
			...
			{
				echo '<a href="'.HOME.APPID.'/print_nota_simple?no_req='.$no_req.'&koreksi=Y"" target="_blank"><b>Preview Nota</b></a> ';		
			}
