...
{   
	...
	function cek_nota($no_req)
	{
		...
		if(count($row_cek) > 0)
		{
			...
			{
				echo '<a href="'.HOME.APPID.'/print_nota?no_req='.$no_req.'&koreksi=N" target="_blank"><b> Preview Nota</b> </a> ';	
			}
			else if($row_cek[0]["NOTA"] <> 'Y' &&  $koreksi == 'Y')
			{
				echo '<a href="'.HOME.APPID.'/print_nota?no_req='.$no_req.'&koreksi=Y" target="_blank"><b> Preview Nota</b> </a> ';	
			}
