        ...
        $query_master	= "SELECT b.KD_PBM, b.nm_pbm, b.almt_pbm, b.no_npwp_pbm,  TO_CHAR(a.TGL_REQUEST,'dd/Mon/yyyy') TGL_REQUEST, COUNT(c.NO_CONTAINER) JUMLAH
 					...
 					AND a.NO_REQUEST = c.NO_REQUEST
  					AND a.no_request = '$no_req'
   					GROUP BY  b.KD_PBM, b.nm_pbm, b.almt_pbm, b.no_npwp_pbm, TO_CHAR(a.TGL_REQUEST,'dd/Mon/yyyy')";
	...
	if($db->query($query_insert_nota) AND $db->query($query_nota_all))
	{
		...
		$row		= $res->getAll();
			 ...
			 $coa    = $item['COA'];
                    ...
                    $update_nota = "UPDATE NOTA_RECEIVING SET CETAK_NOTA = 'Y' WHERE NO_NOTA = '$no_nota'";
					 $update_req = "UPDATE request_delivery SET NOTA = 'Y' WHERE no_request = '$no_nota'";
