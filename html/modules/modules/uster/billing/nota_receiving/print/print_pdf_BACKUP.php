...
<table  >
	...
	';
while (OCIFetchInto ($result_trf_brsh, $row_trf_brsh, OCI_ASSOC)) {
...
while (OCIFetchInto ($result_trf_lo, $row_trf_lo, OCI_ASSOC)) {
...
$html .='<tr>
 ...
 while (OCIFetchInto ($result_trf, $row_trf, OCI_ASSOC)) {
...
//Menghitung Total dasar pengenaan pajak
	...
	$result_materai = OCIparse($conn, $query_materai);
