<?php
	...
	$query_request	= "select rbm.no_request, em.nm_pbm, rbm.biaya, rbm.jenis_bm, rbm.status_gate, rbm.kapal_tuju, vb.nm_kapal, rbm.kd_emkl
						from request_batal_muat rbm inner join kapal_cabang.mst_pbm em on rbm.kd_emkl = em.kd_pbm and em.kd_cabang = '05'
	...
	$res_kapal = $db->query ("select * from v_booking_stack_tpk where no_booking =REPLACE('$row_request[KAPAL_TUJU]','VESSEL_NOTHING','BSK100000023')");
