...
$get_commodity = "select kd_commodity, gross from petikemas_cabang.ttd_cont_exbspl where no_container = '$no_cont'  and kd_pmb = REPLACE('$no_req','DEL','UD')";
$r_commodity = $db->query($get_commodity);
$rw_com = $r_commodity->fetchRow();
$kd_komoditi = $rw_com[KD_COMMODITY];
$komoditi = $rw_com[KD_COMMODITY];
$gross = $rw_com[GROSS];
