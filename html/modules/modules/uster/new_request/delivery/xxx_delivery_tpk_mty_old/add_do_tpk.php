...
//-------------------------------------------------- END INSERT TPK's RECEIVING -------------------------------------------------------//	
              ...
              $query_req    = "INSERT INTO request_delivery(NO_REQUEST, REQ_AWAL, TGL_REQUEST, TGL_REQUEST_DELIVERY, KETERANGAN, CETAK_KARTU, ID_USER, DELIVERY_KE, PERALIHAN, ID_YARD, STATUS,PEB, NPE, KD_EMKL, KD_EMKL2, VESSEL, VOYAGE, TGL_BERANGKAT, KD_PELABUHAN_ASAL, KD_PELABUHAN_TUJUAN, NO_BOOKING, NO_REQ_ICT, TGL_MUAT, TGL_STACKING, NO_RO) 
                                                      VALUES ('$no_req','$no_req',SYSDATE, TO_DATE('".$TGL_REQ."','yyyy/mm/dd'),'$KETERANGAN', '0', $ID_USER, 'TPK','NOTA_KIRIM','$ID_YARD','NEW','$PEB','$NPE','$KD_PELANGGAN', '$KD_PELANGGAN2', '$NM_KAPAL','$VOYAGE_IN',TO_DATE('$TGL_BERANGKAT','dd/mon/yy'),'$KD_PELABUHAN_ASAL','$KD_PELABUHAN_TUJUAN', '$NO_BOOKING','$IDKDPMB','$TGL_MUAT','$TGL_STACKING', '$NO_RO')";
