<?php
		...
		$db2= getDB("ora");
			...
			//==================update tpk==========================
	$sqlcek3 = "SELECT TO_CHAR(DOC_CLOSING_DATE_DRY,'YYYY-MM-DD HH24:MI:SS') AS DOCDATE FROM petikemas_cabang.TTD_VESSEL_SCHEDULE WHERE NO_UKK='".$NO_UKK."'";
	...
	{	
			...
			$sqlhead	= 	"UPDATE PETIKEMAS_CABANG.TTH_CONT_EXBSPL SET
									NO_UKK				= '$NO_UKK',
									TGL_MUAT			= to_date('$TGL_MUAT','DD-MM-YY HH24:MI:SS'),												
									TGL_STACK			= to_date('$TGL_STACKING','DD-MM-YY HH24:MI:SS'),
									TGL_SIMPAN			= SYSDATE,
			...
			$query_req 	= "UPDATE request_delivery SET
							...
							NO_RO 					= '$NO_RO' ,
							TGL_MUAT 				= to_date('$TGL_MUAT','DD-MM-YY HH24:MI:SS'),
							TGL_STACKING			= to_date('$TGL_STACKING','DD-MM-YY HH24:MI:SS'),
