<?php
	...
	$query_request	= "SELECT REQUEST_STUFFING.NO_REQUEST, REQUEST_STUFFING.NO_REQUEST_RECEIVING, REQUEST_STUFFING.NO_REQUEST_DELIVERY,
                        ...
                        BOOK.VOYAGE_IN,
                        BOOK.NO_BOOKING,
                        s.NM_PELABUHAN NM_PELABUHAN_ASAL,
                        t.NM_PELABUHAN NM_PELABUHAN_TUJUAN
               FROM REQUEST_STUFFING
               JOIN KAPAL_CABANG.MST_PBM EMKL
                   ...
                   JOIN V_PKK_CONT BOOK
                    ...
                    JOIN KAPAL_CABANG.mst_pelabuhan s
                    ON BOOK.PELABUHAN_ASAL = s.KD_PELABUHAN 
                    JOIN KAPAL_CABANG.mst_pelabuhan t
                    ON BOOK.PELABUHAN_TUJUAN = t.KD_PELABUHAN
                        ...
                        container_stuffing.COMMODITY COMMO 
                           FROM CONTAINER_STUFFING
                                   ...
                                   ON CONTAINER_STUFFING.NO_REQUEST = REQUEST_STUFFING.NO_REQUEST
                                    INNER JOIN KAPAL_CABANG.MST_PBM e     
