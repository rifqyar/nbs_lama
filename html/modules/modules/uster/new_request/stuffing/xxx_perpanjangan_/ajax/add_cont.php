...
$q_cek_cont = "SELECT NO_CONTAINER FROM PLAN_CONTAINER_STUFFING WHERE NO_CONTAINER = '$no_cont' AND NO_REQUEST = '$no_req_stuf'";
...
if($row_cek_plan["NO_CONTAINER"] == NULL){
	...
	// =========================================== SIMOP ==============================================//
			...
			$history_del        = "INSERT INTO history_container(NO_CONTAINER, NO_REQUEST, KEGIATAN, TGL_UPDATE, ID_USER, ID_YARD, NO_BOOKING, COUNTER) 
									VALUES ('$no_cont','$no_req_stuf','PLAN REQUEST STUFFING',SYSDATE,'$id_user', '$id_yard', '$cur_booking1', '$cur_counter1')";
	...
	echo "Maaf anda telah menambahkan container ".$no_cont." pada request ini";
}
