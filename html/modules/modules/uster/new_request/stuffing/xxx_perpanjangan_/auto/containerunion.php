...
$result =   " SELECT MASTER_CONTAINER.NO_CONTAINER NO_CONTAINER, MASTER_CONTAINER.SIZE_ KD_SIZE, MASTER_CONTAINER.TYPE_ KD_TYPE, 
              ...
              '' VOYAGE_IN, MASTER_CONTAINER.NO_BOOKING NM_KAPAL, '' NM_AGEN, '' TGL_STACK, TO_CHAR(CONTAINER_RECEIVING.TGL_BONGKAR+5, 'dd/mm/rrrr') EMPTY_SD
               ...
               AND master_container.NO_CONTAINER NOT IN (SELECT container_stuffing.NO_CONTAINER FROM container_stuffing where container_stuffing.no_container = '$no_cont' AND container_stuffing.AKTIF = 'Y' )  
            ...
            SELECT TTD_BP_CONT.CONT_NO_BP NO_CONTAINER,
                     ...
                     V_PKK_CONT.NO_UKK, 'TPK' ASAL_CONT,                     
                        ...
                        V_PKK_CONT.NM_KAPAL,
                        V_PKK_CONT.NM_AGEN,
                        To_Char(TTD_BP_CONT.TGL_STACK,'DD-MM-YYYY') AS TGL_STACK, TO_CHAR (TTD_BP_CONFIRM.CONFIRM_DATE+5, 'DD-MM-YYYY') EMPTY_SD
