...
//	$ID_EMKL		= $_POST['ID_EMKL'];
	...
	*/
	...
	if($db->query($query_req))
	{
		...
		{
			$query_select		= "SELECT HZ, VIA, VOYAGE, TO_DATE(TGL_BONGKAR, 'dd/mm/yyyy') TGL_BONGKAR, AFTER_STRIP, TO_DATE(TGL_APPROVE, 'dd/mm/yyyy') TGL_APPROVE FROM CONTAINER_STRIPPING WHERE NO_CONTAINER = '$cont' AND NO_REQUEST = '$no_req' AND AKTIF = 'Y'";
