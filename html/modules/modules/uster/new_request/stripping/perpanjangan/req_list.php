...
$query_list = "SELECT REQUEST_STRIPPING.NO_REQUEST, 
                ...
                GROUP BY REQUEST_STRIPPING.NO_REQUEST,REQUEST_STRIPPING.NO_DO,REQUEST_STRIPPING.TGL_REQUEST, NVL(nota_stripping.LUNAS, 0),
                        REQUEST_STRIPPING.NOTA,REQUEST_STRIPPING.NO_BL, REQUEST_STRIPPING.KOREKSI, REQUEST_STRIPPING.TGL_APPROVE, TO_CHAR( REQUEST_STRIPPING.TGL_AWAL,'dd/mm/yyyy'), emkl.NM_PBM, pnmt.NM_PBM,  TO_CHAR( REQUEST_STRIPPING.TGL_AKHIR,'dd/mm/yyyy'), REQUEST_STRIPPING.PERP_DARI, REQUEST_STRIPPING.PERP_KE
