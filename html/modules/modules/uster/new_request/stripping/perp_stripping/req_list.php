...
//------------------------	
  ...
  if($_POST["no_req"] != NULL && $_POST["from"] == NULL && $_POST["to"] == NULL)
                ...
                FROM REQUEST_STRIPPING,V_MST_PBM emkl,CONTAINER_STRIPPING, NOTA_STRIPPING
                ...
                GROUP BY container_stripping.NO_CONTAINER,REQUEST_STRIPPING.NO_REQUEST,REQUEST_STRIPPING.NO_DO,REQUEST_STRIPPING.TGL_REQUEST, NVL(nota_stripping.LUNAS, 0),
                        REQUEST_STRIPPING.NOTA,REQUEST_STRIPPING.NO_BL, REQUEST_STRIPPING.TGL_APPROVE, TO_CHAR( REQUEST_STRIPPING.TGL_AWAL,'dd/mm/yyyy'), emkl.NM_PBM,  TO_CHAR( REQUEST_STRIPPING.TGL_AKHIR,'dd/mm/yyyy'), REQUEST_STRIPPING.PERP_DARI, REQUEST_STRIPPING.PERP_KE
...
$query_list = " SELECT REQUEST_STRIPPING.NO_REQUEST, 
	...
	*/
	$query_list = "SELECT DISTINCT * FROM (
                ...
                GROUP BY container_stripping.NO_CONTAINER,REQUEST_STRIPPING.NO_REQUEST,REQUEST_STRIPPING.NO_DO,REQUEST_STRIPPING.TGL_REQUEST, NVL(nota_stripping.LUNAS, 0),
                        REQUEST_STRIPPING.NOTA,REQUEST_STRIPPING.NO_BL, REQUEST_STRIPPING.TGL_APPROVE, TO_CHAR( REQUEST_STRIPPING.TGL_AWAL,'dd/mm/yyyy'), emkl.NM_PBM,  TO_CHAR( REQUEST_STRIPPING.TGL_AKHIR,'dd/mm/yyyy'), REQUEST_STRIPPING.PERP_DARI, REQUEST_STRIPPING.PERP_KE
                ORDER BY REQUEST_STRIPPING.NO_REQUEST DESC, REQUEST_STRIPPING.TGL_REQUEST DESC)";
