...
$query			= /*"SELECT b.NO_CONTAINER AS NO_CONTAINER,
                    ...
                    and b.NO_CONTAINER LIKE '%$no_cont%'
					"*/
					"SELECT b.NO_CONTAINER AS NO_CONTAINER,
                          b.NO_REQUEST AS NO_REQUEST,
                          a.SIZE_ AS SIZE_,
                          a.TYPE_ AS TYPE_,
                          b.STATUS AS STATUS,
						  ...
						  e.NOPOL AS NOPOL
                    FROM 
                   PETIKEMAS_CABANG.TTD_BP_CONT TD,
                         MASTER_CONTAINER a INNER JOIN 
                         CONTAINER_RECEIVING b ON a.NO_CONTAINER = b.NO_CONTAINER JOIN
                         REQUEST_RECEIVING c ON  b.NO_REQUEST = c.NO_REQUEST 
						 --JOIN V_MST_PBM d ON  c.KD_CONSIGNEE = d.KD_PBM  
                         left JOIN BORDER_GATE_OUT e ON ( b.NO_REQUEST = e.NO_REQUEST AND
                                               a.NO_CONTAINER = e.NO_CONTAINER
                                                                  )            
                    WHERE c.RECEIVING_DARI = 'TPK'
                    and td.status_cont = '10' 
                    and b.NO_CONTAINER = TD.CONT_NO_BP
					--and TD.bp_id = b.NO_BOOKING
                    and b.NO_CONTAINER LIKE '%$no_cont%'
