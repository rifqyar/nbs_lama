...
<body>
<img src="images/LAYOUT_USTER_18OCT2012.jpg" usemap="#mapuster">
...
<map name="mapuster">
									...
									foreach ($data as $row){
									?>
  <area bgcolor="green" id="rect" shape="rect" coords="<?=$row['X1']?>,<?=$row['Y1']?>, <?=$row['X2']?>, <?=$row['Y2']?>" alt="Sun" data-tooltip="<?=$row['LOKASI']?>"/>
  <?}?>
</map>
