...
function search_request()
{
	...
	{
		 $("#list_container").jqGrid('setGridParam',{url:"<?=HOME?>datanya/data_2?q=list_cont_sti&kg="+keg+"&no_ukks="+no_ukk, datatype:"json"}).trigger("reloadGrid");
	}
}
...
function ganti()
{
	...
	if(keg=="E")
	{
		 ...
		 jQuery("#list_container").jqGrid({
			...
			mtype : "post",
			datatype: "json",
			colNames:['Nama Alat', 'Sz - Ty - Sts - Hz', 'Gross','Kode Status', 'Gate In<br>Jobslip', 'Yard<br>Allocation<br>Block - Slot', 'Date<br>Placement', 'Yard<br>Placement<br>B - S - R - T','Bay Plan<br>B - R - T','Bay Realization<br>B - R - T','Haulage Export','Date<br>Loading Confirm'], 
			colModel:[
				...
				{name:'hl',index:'hl', width:110, align:"center"},
	...
	{	
		 ...
		 jQuery("#list_container").jqGrid({
			...
			mtype : "post",
			datatype: "json",
			colNames:['Container Numb.', 'Sz - Ty - Sts - Hz','Gross','Kode Status','Bay Position<br>B - R - T','Date<br>Discharge Confirm', 'Yard<br>Allocation<br>Block - Slot', 'Date<br>Placement', 'Yard<br>Placement<br>B - S - R - T','Gate In','Pick Up Delivery','Gate Out'], 
			colModel:[
				{name:'cont',index:'cont', width:100, align:"center"},
				{name:'stst',index:'stst', width:100, align:"center"},
				{name:'gross',index:'gross', width:70, align:"center"},
				...
				{name:'ydplc',index:'ydplc', width:80, align:"center"},	
				{name:'gi',index:'gi', width:110, align:"center"},
				{name:'pk',index:'pk', width:80, align:"center"},
...
<div class="content">
	<div class="main_side">
	<p>
	<img src="<?=HOME?>images/icon_mvmt.png" height="7%" width="7%" style="vertical-align:middle">
		<b> <font color='#69b3e2' size='4px'>&nbsp;Monitoring</font> </b>
