...
jQuery(function() {
 jQuery("#bm").jqGrid({
	...
	mtype : "post",
	datatype: "json",
	colNames:['NO NOTA','DESCR','NO_REQUEST','CUSTOMER','DATE CREATED','BIAYA','DATE PAID','AR STATUS','AR DATE','RECEIPT STATUS','RECEIPT DATE'], 
	colModel:[
		{name:'nonota', width:120, align:"center",sortable:false,search:false},
...
function transfer()
{
	...
	$.post(urltransfer, function(data)
		{
...
<div class="content">
	...
	<BR><button onclick="transfer()"> Click untuk transfer <img src='images/trflfg2.png' ></button>
		<br/><br/>
