...
$query_h	= 	"SELECT B.VESSEL, 
						...
						CASE A.ID_STATUS 
							...
							WHEN '02' THEN '-'
							WHEN '03' THEN '-'
							ELSE to_char(A.GATE_IN,'DD-MON-YYYY:HH24:MI') END as GATE_IN,
						...
						CASE A.ID_STATUS 
							...
							WHEN '03' THEN '-'
							WHEN '02' THEN '-'
							ELSE to_char(A.PLACEMENT,'DD-MON-YYYY:HH24:MI') 
							END AS PLACEMENT,
						 
						CASE A.PLUG_IN 
							WHEN NULL THEN '-'
							ELSE to_char(A.PLUG_IN,'DD-MON-YYYY:HH24:MI')  
							END as PLUG_IN, 
				...
				WHERE 
						A.NO_UKK= '$no_ukk' AND A.REMARK_='R'
...
$tier		= $rows['TIER'];
 ...
 ?>
		...
		<table>
		<tr><th align="center" colspan="24" face="tahoma"><h3>CONTAINER MOVEMENT EXPORT </h3></th></tr>&nbsp;
