                  ...
                  <?	}else if (($size_ == '40') && ($type_ == 'DRY') &&($status_ =='FCL')){ ?>
				   ...
				   <?    } else if ($kategori2 == '3'){ ?>
					 ...
					 <?    } else if ($kategori2 == '4'){ ?>
				   	 ...
				   	 <?    } else if ($kategori2 == '7'){ ?>
                           <td onMouseOver="this.style.backgroundColor='#CCFF33'" onMouseOut="this.style.backgroundColor='#86BCFF'" align="center" style="width:30px;height:15px;font-size:8px; font-family:Tahoma;background-image:url('yard/src/css/excite-bike/images/OVD.png');background-size:10px 5px"  <?=$cr?>>kat <?=$kategori2?></td>
					<?    } else if ($kategori2 == '8'){ ?>
                           <td onMouseOver="this.style.backgroundColor='#CCFF33'" onMouseOut="this.style.backgroundColor='#86BCFF'" align="center" style="width:30px;height:15px;font-size:8px; font-family:Tahoma;background-image:url('yard/src/css/excite-bike/images/empty.png');background-size:10px 5px"  <?=$cr?>>kat <?=$kategori2?></td>
						   	 <?    } else if ($kategori2 == '9'){ ?>
