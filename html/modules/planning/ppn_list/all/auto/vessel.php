...
$db 			= getDB('dbint');	
$query 			= "select VESSEL AS NM_KAPAL, ID_VSB_VOYAGE AS NO_UKK, VOYAGE_IN AS VOYAGE, VOYAGE_OUT, CALL_SIGN,
					...
					, TO_CHAR(TO_DATE(ATD,'YYYYMMDDHH24MISS'), 'DD-MM-YYYY HH24:Mi') TGL_JAM_BERANGKAT, ETA 
					from M_VSB_VOYAGE WHERE VESSEL LIKE '%$nama%' OR VOYAGE_IN LIKE '%$nama%' OR VOYAGE_OUT LIKE '%$nama%'
					order by no_ukk desc";
